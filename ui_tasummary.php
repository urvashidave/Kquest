...
<tr>
<td width="900" colspan="2" align="center" valign="middle"><span class="blue22"><strong class="stitle"><?php echo strtoupper($report_label_type);?></strong></span><br>
...
<div class="print_pages" align="left" style="height:675px">
...
<tr>
<td height="74" align="center" valign="top" class="black18"><p style="margin: 0; padding: 0;"><strong><?php 
...
<tr>
<td height ='50' bgcolor='#e0e0e0'>" . $sorted_segment_percent[0] . "% of market area<br>" 
...
<tr>
<td height ='50' bgcolor='#e0e0e0'>" . $sorted_segment_percent[1] . "% of market area<br>" 
...
<tr>
<td height ='50' bgcolor='#e0e0e0'>" . $sorted_segment_percent[2] . "% of market area<br>" 
...
<tr>
<td height ='50' bgcolor='#e0e0e0'>" . $sorted_segment_percent[3] . "% of market area<br>" 
...
<td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
<tr>
<td align='center'><img src='" . $sorted_segment_picture[4] . ".jpg' width='150' height='150'></td>
</tr>
<tr>
<td align='center' height ='50' class='sgrey14'><strong>" . $sorted_segment_high[4] . "</strong></td>
</tr>
<tr>
<td height ='50' bgcolor='#e0e0e0'>" . $sorted_segment_percent[4] . "% of market area<br>" 
. $sorted_segment_benchmark[4] . "% of benchmark <br> <b>Index "
. $sorted_segment_index[4] . "</b><br>
</td>
</tr>
<tr>
<td height ='120' >". $sorted_segment_description[4] ."
</td>
</tr>
</table></td>
</tr>
...
<div class="print_pages last_page" align="left" style="height:665px;">
