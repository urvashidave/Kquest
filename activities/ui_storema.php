...
<div class="container row col-md-12 print_pages align="center""> 
  ...
  <tr>
    <td width="900" colspan="2" align="center" valign="top"><span class="blue22"><strong>MARKET AREA INSIGHTS</strong></span><br>
      ...
      Store # <?php echo $store_number; ?>, <?php echo $store_name; ?><br>
  ...
  <tr>
    <td width="880" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="42%" align="left"><strong class="black18">Store  #<?php echo $store_number . " - " . $store_name ; ?></strong><br>
          <span class="black141">Profile of entire market area</span></td>
    ...
    <tr>
      <td colspan="2" class="sorange20"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="42%" align="left" valign="top"><strong class="black18">Store  #<?php echo $store_number . " - " . $store_name ; ?></strong><br>
            <span class="black141">Profile of entire market area</span></td>
      ...
      <td width="50%" align="center" valign="top"><br>
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td valign="top" class="sgrey14"><p><strong><span class="black16">Primary Family Structure Cohort</span></strong></p>
      ...
      <td align="center" valign="top"><br>
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td valign="top" class="sgrey14"><p class="sgrey14"><strong><span class="black16">Primary Age Cohort</span></strong></p>
                ...
                <td width="905" height="600" colspan="2"><table width="100%" height="600" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
                        <td width="42%" height="63" align="left" valign="top"><span class="sgrey14"><strong class="black18">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?></strong><br>
                        </span><span class="black141">Market Area compared to National Average</span></td>
    ...
    <tr>
      <td width="500" colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="48%" align="left" valign="top"><span class="sgrey14"><strong class="psub2">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?></strong><br>
          </span><span class="pbody">Profile of entire Market Area </span></td>
...
<a class="btn btn-primary btn-sm" onClick="detail_show4(<?php echo $store_uid ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
    ...
    <tr>
      <td colspan="2" align="center"><span class="psub1">Consumption per household in the market area is $<?php echo number_format($hhb_consume); ?><br> 
      This is $<?php echo number_format(abs($hhdiff_consume)); if ($hhdiff_consume > 0) echo " higher"; else echo " lower"; ?> than the Canadian average of $<?php echo number_format($hha_consume); ?></span></td>
    </tr>
    <tr>
          ...
          <td width="33%" align="center" valign="top"><table width='95%' class='pborder1'>
            <tr>
              <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                ...
                <tr>
                  <td height ='90' class="pbodyemp" >$<?php echo number_format($hhbcommit); ?> market area<br>
          ...
          <td width="33%" align="center" valign="top"><table width='95%' class='pborder1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  ...
                  <tr>
                    <td height ='90' ><strong class="pbodyemp">$<?php echo number_format($hhb_purchases); ?> market area<br>
          ...
          <td width="33%" align="center" valign="top"><table width='95%' class='pborder1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  ...
                  <tr>
                    <td height ='90' ><strong class="pbodyemp">$<?php echo number_format($hhb_discretionary); ?> market area<br>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="67%" align="left" valign="top"><strong class="black18">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?></strong><br>
            <span class="black141">Entire Market Area -  (index compared to National average) age 15+</span></td>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="61"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="60%" align="left" valign="top"><strong class="black18">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?></strong><br>
            <span class="black141">Entire Market Area -  (index compared to National average) age 15+</span></td>
