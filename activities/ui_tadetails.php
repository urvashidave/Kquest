...
<div class="container row col-md-12 no-print align="center"">    
      		...
      		<input name="ads" type="button" class="sblue" id="ads" value="Back to Dashboard" onClick="HOMEsubmit();" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="ads2aa" type="button" class="sblue" id="ads2aa" value="ROI flyer counter" onClick="CALCREPORTsubmit2(<?php echo $report_uid * 3571; ?>);" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="get_detailed" type="button" class="sblue" id="get_detailed" value="View Details" onClick="TADETAILsubmit2(<?php echo $report_uid * 3571; ?>);" /> 
  ...
  <tr>
    <td width="900" height="122" colspan="2" align="center" valign="top"><strong class="stitle"> 
      STORE MARKET <br>AREA PROFILE<br>
    </strong><span class="sorange30"><strong>Store <?php echo $store_number; ?>, <?php echo $store_name; ?></strong><strong class="stitle"></strong></span></td>
    </tr>
  <tr>
    <td colspan="2" align="center" valign="top">&nbsp;</td>
  </tr>
  <tr >
    <td colspan="2" align="center"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="85%" align="right"><strong class="stitle">LOCATION</strong></td>
      </tr>
      <tr>
        <td colspan="2">Store  #<?php echo $store_number . " - " . $store_name ; ?> - Profile of entire market area</td>
        </tr>
    </table></td>
    </tr>
  <tr>
    <td><h3><span class="grey14">
      ...
      (Homes: <?php echo number_format($mfd_home); ?> &#8226; Apartments: <?php echo number_format($mfd_apts); ?> &#8226; Farms: <?php echo number_format($mfd_farms); ?>)</span></h3></td>
    <td width="226">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2"><div id="map" style="width: 100%; height: 420px"></div></td>
  </tr>
</table>
</div>
  ...
  <table width="900px" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="2" class="sorange20"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="2" class="sgrey14">Store  #<?php echo $store_number . " - " . $store_name ; ?> - Profile of entire market area</td>
        </tr>
      </table></td>
    </tr>
                ...
                <td width="905" height="600" colspan="2"><table width="100%" height="600" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15%"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
                        <td width="85%" height="63" align="right"><strong class="stitle"> SEGMENTATION</strong></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td width="79%" height="20"><span class="sgrey14">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?> - 
                      <span class="sgrey141">Market Area</span> <span class="sgrey141">compared to National Average</span></span></td>
                  ...
                  <tr>
                    <td colspan="2" align="center"><strong><span class="sblue"><?php echo number_format($segment_counter); ?> Vital segments were identified</span></strong><br>
                      <strong><span class="sgrey14">These vital segments represent <?php echo number_format($vitalsegment_p); ?>% of your entire market area and <?php echo number_format($vitalsegment_c); ?>% of Canadian households (index <?php echo number_format($vitalsegment_p / $vitalsegment_c *100); ?>)</span></strong></td>
                  </tr>
                  <tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td width="500" colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="85%" align="right"><strong class="stitle">SPENDING</strong></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="2" align="left"><span class="sgrey14">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?> - <span class="sgrey141">Market Area</span> <span class="sgrey141">compared to National Average</span></span></td>
    </tr>
    <tr>
      <td colspan="2" align="left"><span class="sgrey12">Consumption per household in the market area is $<?php echo number_format($hhb_consume); ?>; this is $<?php echo number_format(abs($hhdiff_consume)); if ($hhdiff_consume > 0) echo " higher"; else echo " lower"; ?> than the Canadian average of $<?php echo number_format($hha_consume); ?></span></td>
    </tr>
    <tr>
          ...
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
            <tr>
              <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                ...
                <tr>
                  <td align='center' height ='50' class='sgrey14'><img src="activities/house.jpg" width="200" height="200" alt="house"></td>
                  </tr>
                <tr>
                  <td height ='20'>&nbsp;</td>
                  </tr>
                <tr>
                  <td height ='70' bgcolor='#e0e0e0'><span class="sgrey14"><strong>$<?php echo number_format($hhbcommit); ?> market area<br>
                    $<?php echo number_format($hhacommit); ?> Canada <br>
                    $<?php echo number_format($hhdiffcommit); ?> difference</strong></span></td>
                  </tr>
                <tr>
          ...
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  ...
                  <tr>
                    <td align='center' height ='50' class='sgrey14'><img src="activities/clothes.jpg" width="200" height="200" alt="clothes"></td>
                    </tr>
                  <tr>
                    <td height ='20'>&nbsp;</td>
                  </tr>
                  <tr>
                    <td height ='70' bgcolor='#e0e0e0' class="sgrey14"><strong>$<?php echo number_format($hhb_purchases); ?> market area<br>
          ...
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  ...
                  <tr>
                    <td height ='70' bgcolor='#e0e0e0' class="sgrey14"><strong>$<?php echo number_format($hhb_discretionary); ?> market area<br>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="85%" align="right"><strong class="stitle">MEDIA</strong></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td><span class="grey14">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?> - 
      Entire Market Area -  (index compared to National average) age 15+</span></td>
    </tr>
    <tr>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="61"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="85%" align="right"><strong class="stitle">LIFESTYLE</strong></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td height="30"><span class="grey14">Store #<?php echo $store_number; ?>, <?php echo $store_name; ?> - 
      Entire Market Area -  (index compared to National average) age 15+</span></td>
    </tr>
    <tr>
