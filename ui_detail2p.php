...
div.page { page-break-after: avoid

 }
 
 .details {page-break-after: avoid !important;
...
.style15 {font-size: 18px;margin-left: 14px;}
...
<div class="print_pages detail" align="left" style="height: 605px;"> 

  <table width="900px" height="600" border="0" cellspacing="0" cellpadding="0">

    <tr>

      <td colspan="2" align="left" valign="top"><table width="101%" border="0" cellspacing="0" cellpadding="0">
   ...
   <td width="152" height="72" align="left" valign="top" style="padding-top: 12px; padding-left: 19px;"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
...
<td width="315" align="right" style="padding-top: 4px;   padding-right: 15px;"><span class="pheading"><strong class="stitle">DEMOGRAPHICS</strong></span><strong class="stitle"><br>
 ...
 <?php if ($detail_show != 2) {

 	echo '<a class="btn btn-primary btn-sm" onClick="DETAILsubmit_2(2271156);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
...
<td width="51%" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
...
<div id="piechart_3d" style="width: 350px; height: 300px; background-color: transparent;font-size: 16px !important"></div></td>

<td align="center"><span class="style2" style="font-size: 17px">Ethnic Diversity</span>

<div id="piechart_3d2" style="width: 350px; height: 300px; background-color: transparent; font-size: 16px !important"></div></td>
...
<div class="row col-md-12 print_pages" align="left" style="height: 620px"> 

<td><table width="889" height="580" border="0" cellspacing="0" cellpadding="6">

<tr>

<td width="900" height="83" colspan="2" padding-right:""><table width="875" height="61"border="0" cellspacing="" cellpadding="4">

<tr>



     <td width="129" height="72" align="left" valign="top" style="padding-left: 0px;"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
...
<td width="340" align="right" valign="top"><strong class="stitle">AGE OF ADULTS</strong></td>
...
<td colspan="4" align="center" class="psub2 style15">Age of Adults as a Percentage of Market</td>
...
<div class="row col-md-12 print_pages" align="left" style="height: 600px;">

<td><table width="889" height="575" border="0" cellspacing="0" cellpadding="6">

<tr>

<td width="900" height="83" colspan="2" padding-right:""><table width="872" height="67"border="0" cellpadding="4" cellspacing="">
...
<td width="358" align="right" valign="top"><strong class="stitle">FAMILY STRUCTURE</strong><br>
...
<td colspan="4" align="center" class="psub2 style15">Family Structures as a Percentage of Market</td>
...
<td><table width="888" height="507" border="0" cellspacing="0" cellpadding="6">

<tr>

<td width="876" height="79" colspan="2" padding-right:""><table width="872" height="67"border="0" cellpadding="4" cellspacing="">
...
<td width="139" align="right" valign="top"><strong class="stitle">INCOME</strong><br>
...
<span class="pbody12">Target Audience  compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
...
<div class="row col-md-12 print_pages" align="left" style="height: 630px;"> 

<td><table width="889" height="620" border="0" cellspacing="0" cellpadding="6">

<tr>

<td width="900" height="611" colspan="2" padding-right:""><table width="873" height="62"border="0" cellpadding="4" cellspacing="">
...
<td width="272" align="right" valign="top"><strong class="stitle">DETAILS</strong></td>
...
<table width="780px" border="1" align="center" cellpadding="2" cellspacing="2" class="sgrey12">

<tr>

<td width="400"><span class="style5">Age of Adults</span></td>

<td width="125"><div align="center"><span class="sgrey14">Target Audience</span></div></td>
...
<td><span class="style5">Age of Children</span></td>
...
<td><span class="style5">Household Income</span></td>
...
<td><span class="style5"> Average Household Income</span></td>
...
</table><span class="pbody12" style="padding-left: 44px;">Market area compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
...
<div class="row col-md-12 print_pages" align="left" style="height: 620px;"> 
  ...
  <table width="887" height="62"border="0" cellspacing="" cellpadding="4">

<tr>



 <td width="129" height="72" align="left" padding-right:"5"  valign="top" style="padding-left: 0px;"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
...
<td width="183" align="right" valign="top"><strong class="stitle">DETAILS </strong></td>
...
<td><span class="style5">Ethnic Diversity</span></td>
...
<td height="22" style="padding-left:14px;">Caucasian</td>
...
</table><span class="pbody12" style="padding-left: 349px;">Target Audience area compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span>
