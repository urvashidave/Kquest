...
$query = "SELECT * FROM amfd_stores WHERE store_uid = $store_uid  ORDER BY store_number ";
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		//$store_pc = preg_replace("/[^a-zA-Z0-9]+/", "", $temp_store_pc); // added 'remove space'  Brad Feb 15 2019 
		$store_pc = preg_replace("/[^a-zA-Z0-9 ]+/", "", $temp_store_pc);
		$client_id = $row['client_id'];
		$kml_id = $row['kml_id'];
		$store_number = $row['store_number'];
		$store_name = $row['store_name'];
		//$store_pc = $row['store_pc'];		// removed Brad Feb 15 2019 
...
.print_pages {page-break-after: avoid}
div.page { page-break-after: always }
...
// updated august 28 2018 - c_geo to amfd_homes_current
	...
	$temp_ethnic_lat = 43;	// added default Feb 15 2019 - ensure map will work in case query cannot find a valid postal code
	$temp_ethnic_lon = -79;	// added default Feb 15 2019
...
<p class="black14">Select report : 
  <select id="myReport" class=""  onchange="list_report()">
<option  disabled >Report to View</option>
<option value="14" <?php if($detail_show == 14) echo "selected='selected'";?>>Key Highlights</option>
...
<br />
<br />
<!--<button class='form-button-blue bg_color1' id="seq_targeting_but" type="button" onclick='seq_targeting1(<?php echo $original_store;?>)'>Sequential Targeting</button> -->
<button class="form-button-blue bg_color1" onclick="change_report2()">Show Retailer Map</button>
<input name="change_report" type="submit" class="form-button-blue bg_color1" id="change_report"  onClick="change_report(<?php echo $store_uid ; ?>);" value="Update Report" /></p></td>
</tr>
</table>
</div> 
...
/// select the agg anbd pages to view 
if ($detail_show == 0 || $detail_show == 10) include 'ui_tasummary.php';  
// demographics
if ( $detail_show == 2) { include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detail2ta.php"; echo "</div"; }
// spending 
if ( $detail_show == 4) {  include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detail4ta.php"; echo "</div"; }
// Media 
if ( $detail_show == 5) {  include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detail5ta.php"; echo "</div"; }
// lifestyle
if ( $detail_show == 6) {  include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detail6ta.php"; echo "</div"; }
// Automotive
if ( $detail_show == 7) {  include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detail8ta.php"; echo "</div"; }
// iMPROVE
if ( $detail_show == 8) {  include "ui_detail_cover.php";   echo "<div class='pagebreak'></div>"; echo "<div class='page-wrap '>";  include "ui_detailhhta.php";   echo "</div"; }

if ( $detail_show == 9) { include "ui_compareta.php";  }
if ( $detail_show == 11) { echo "<div class='page-wrap '>"; include "ui_detail_rest_ta.php";  echo "</div"; }
//if ( $detail_show == 12) { include "ui_detail_grocery_ta.php";  }
if ( $detail_show == 12) { echo "<div class='page-wrap '>"; include "ui_detail_retail_ta.php";   echo "</div";}
if ( $detail_show == 14) {  echo "<div class='page-wrap '>";  include "tradearea.report.key_highlights.php";   echo "</div"; }
