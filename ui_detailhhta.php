...
$all_agehomes1['dwellings'] = $all_agehomes1['homes'] + $all_agehomes1['apts'];
...
?>
 ...
 <table width="96%" height="650" border="0" cellspacing="1" cellpadding="0">
 <tr>
 ...
 <td class="style4"><?php echo $stop_retail['name'][0]; ?><img src="<?php echo $stop_retail['pic'][0]; ?>" width="150" height="150" /><br />
 ...
 <div class="pagebreak"> </div>
 <div class="print_pages align="left""> 
 <table width="96%" height="664" border="0" cellspacing="4" cellpadding="0">
 <tr>
...
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
 ...
 Top 5 major renovation projects in the past 2 years ranked by percent of renovations (arrow represents comparison compared tot he benchmark average)</span></p>
 </td>
 </tr>
 </table>
 </div>
 ...
 <td width="42%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br />
 <?php echo $change_title2; ?></span></td>
 <td width="43%" align="right" class="stitle">Top Renovations</td>
 </tr>
 </table></td>
 </tr>
 <tr>
 <td width="50%" align="center" valign="top" class="style12"><table width="100%" class="Example_E1">
 <tr>
 ...
 <tr>
 <td align="center" class="style24">15</td>
 ...
 Top renovations in the past 2 years ranked by percent of households<br /><span class="pbody12">Market area compared to 
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
 </tr>
 </table>
 </div>
 <div class=" print_pages align="left="left""">
   <table width="90%" height="664" border="0" cellspacing="4" cellpadding="4">
     <tr>
       <td width="100%" height="79" colspan="2" ><table width="100%" border="0" cellspacing="2" cellpadding="1">
         <tr>
           <td width="132" height="60" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
           <td width="42%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br />
             <?php echo $change_title2; ?></span></td>
     ...
     <tr>
       <td colspan="2" align="center" valign="top" class="style12"><table width="95%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td align="center" valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td width="44" class="style12"><strong>Construction Date</strong></td>
             ...
             <tr>
               ...
               <td align="left" class="style12"><?php echo number_format($demo['agehomes'][2],0) . " (". number_format($agehomes['percent'][2],1) . "%)";?></td>
             </tr>
             <tr>
               <td class="style12">2014</td>
               <td align="left" class="style12"><?php echo number_format($demo['agehomes'][3],0) . " (". number_format($agehomes['percent'][3],1) . "%)";?></td>
             </tr>
             <tr>
               <td class="style12">2015</td>
               <td align="left" class="style12"><?php echo number_format($demo['agehomes'][4],0) . " (". number_format($agehomes['percent'][4],1) . "%)";?></td>
             </tr>
             <tr>
               <td class="style12">2016</td>
               <td align="left" class="style12"><?php echo number_format($demo['agehomes'][5],0) . " (". number_format($agehomes['percent'][5],1) . "%)";?></td>
             </tr>
           </table></td>
           <td><img src="build_home.jpg" width="570" height="450" alt="home" /></td>
         </tr>
       </table></td>
     </tr>
   </table>
 ...
 <tr >
   ...
   <th align="left"><div align="center"><strong><span class="pbodyemp">Market <br />
     Area</span></strong></div></th>
   <th align="left"><div align="center"><strong><span class="pbodyemp">Benchmark<br />
   </span></strong></div></th>
...
** 
     &quot;Households analyzed&quot; are the households with demographic and other attributes available and displayed in this report<br />
Market area compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
 <td width="51%" valign="top" ><table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
   <tr >
     ...
     <th width="106" align="left"><div align="center"><strong><span class="pbodyemp">Market <br />
       Area</span></strong></div></th>
     <th width="77" align="left"><div align="center"><strong><span class="pbodyemp">Benchmark<br />
     </span></strong></div></th>
   ...
   <table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
     ...
     <tr class="style12">
       <td><strong>Total of all dwellings </strong></td>
      <td align="center"><strong><?php echo number_format($all_agehomes1['homes'],0) . " (". number_format($all_agehomes1['homesp'],1) . "%)";?></strong></td>
      <td align="center"><strong><?php echo number_format($all_agehomes1['apts'],0) . " (". number_format($all_agehomes1['aptsp'],1) . "%)";?></strong></td>
       <td align="center"><strong><?php echo number_format(($all_agehomes1['homes']+$all_agehomes1['apts']));?></strong></td>
     </tr>
   </table>
 ...
 <td width="49%" valign="top" ><table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
 <tr >
 <th align="left"><strong><span class="pbodyemp">Renovation Projects<br />
 past 2 years</span></strong></th>
 <th width="75" align="left"><div align="center"><strong><span class="pbodyemp">Market <br />
 Area</span></strong></div></th>
 <th width="75" align="left"><div align="center"><strong><span class="pbodyemp">Benchmark<br />
 </span></strong></div></th>
 <th width="63" align="left"><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
 </tr>
 <tr class="style4">
...
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
 ...
 <div class=" print_pages align="left"">
 <table width="99%" height="679" border="0" cellspacing="4" cellpadding="0">
 <tr>
 ...
 <th width="119" align="left"><div align="center"><strong><span class="pbodyemp">Market <br />
 Area</span></strong></div></th>
 <th width="83" align="left"><div align="center"><strong><span class="pbodyemp">Benchmark<br />
 </span></strong></div></th>
 ...
 <td width="38%" align="center"  valign="top" ><div align="centre"><img src="home_improve.jpg" alt="retailers" width="311" height="205" align="center" /></div><span class="pbody12">Market area compared to 
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
 </tr>
 </table>
 </div>
 <div class="pagebreak"> </div>
 <div class=" print_pages align="left"">
 <table wwidth="901" height="623" border="0" cellspacing="4" cellpadding="0">
 <tr>
