  ...
  <tr>
    ...
    <td height="77" colspan="2" ><table width="99%" border="0" cellspacing="4" cellpadding="4">
       ...
       <td width="118" height="58" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
        ...
        <td width="314" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br>

        <?php echo $change_title2; ?></span></td>

      <td width="423" align="right"><strong class="pheading"> Automotive Summary </strong></td>
...
<table align="center" width="96%" height="557" border="0" cellspacing="0" cellpadding="0">
  ...
  <td colspan="3" align="center" valign="middle" ><table width="96%" height="51" border="0" cellpadding="2" cellspacing="0" class="table_trans">
    ...
    <tr>
      ...
      <td width="50%" height="24" align="center" valign="middle" bgcolor="#eaeaea"><span class="pbodyemp"><?php echo number_format($at_total['tot_vehicles'],0);?> vehicles in market area</span></td>
    ...
    <tr>
      ...
      <td align="center" valign="middle" bgcolor="#eaeaea"><span class="pbodyemp"> <?php echo number_format($pAU_PPULP + $pAU_PPUP,1); ?>% intend to buy this year</span></td>
...
<div class="print_pages" align="left" style="height: 660px;"> 
  ...
  <tr>
    ...
    <td height="79" colspan="2" ><table width="100%" border="0" cellspacing="4" cellpadding="4">
     ...
     <td width="132" height="60" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
        ...
        <td width="43%" align="right" class="pheading">Current Vehicle</td>
  ...
  <td width="50%" valign="top" ><table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" class="pbody12">
    ...
    <tr >
      ...
      <th width="205" align="left" ><strong><span class="pbodyemp">Area summary</span></strong></th>

      <th colspan="3" align="left"><div align="center"><strong><span class="pbodyemp">Market Area</span></strong></div></th>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td colspan="3" class="pbodyemp"><div align="center" class="style5">
        ...
        <div align="left"><span class="style4"><?php echo number_format($at_total['tot_vehicles'],0);?> owned in the entire market area</span></div>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td colspan="3" align="left" class="pbodyemp"><div align="center" class="style5">

        <div align="left"><span class="style4"><?php echo number_format($at_total['tot_vehicles']/$hh_tot,1);?></span></div>
      ...
      <tr >
        ...
        <th align="left" ><strong><span class="pbodyemp">Vehicles Per Household</span></strong></th>

        <th width="45" align="left"><div align="center"><strong><span class="pbodyemp">Market <br />

          Area</span></strong></div></th>

        <th width="88" align="left"><div align="center"><strong><span class="pbodyemp"><span class="style1">Benchmark</span><br />

          Average</span></strong></div></th>

        <th width="62" align="left"><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
      ...
      <tr >
        ...
        <th align="left"><strong><span class="pbodyemp">Annual Km Driven</span></strong></th>

        <th align="left"><div align="center"><strong><span class="pbodyemp">Market <br />

          Area</span></strong></div></th>

        <th align="left"><div align="center"><strong><span class="pbodyemp"><span class="style1">Benchmark</span><br />
      ...
      <tr class="pbodyemp">
        ...
        <td><span class="pbodyemp">Age of Vehicle </span></td>

        <td class="pbodyemp"><div align="center"><span class="pbodyemp"><strong> Market Area</strong></span></div></td>

        <td class="pbodyemp"><div align="center"><span class="style1">Benchmark</span><br />
          Average
        </div></td>

        <td class="pbodyemp"><div align="center"><span class="pbodyemp"><strong>Index</strong></span></div></td>
...
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
  ...
  <td width="50%" valign="top" ><table width="95%" border="1" cellpadding="0" cellspacing="0" class="pbody12">
       ...
       <tr >
         ...
         <th width="155" align="left"><strong><span class="pbodyemp">Type of vehicle most often driven</span></strong></th>

         <th width="106" align="left"><div align="center"><strong><span class="pbodyemp">Market <br />

           Area</span></strong></div></th>

         <th width="77" align="left"><div align="center"><strong><span class="pbodyemp"><span class="style1">Benchmark</span><br />
       ...
       <tr >
         ...
         <th align="left"><strong><span class="pbodyemp">Value of vehicle  (past 2 years)</span></strong></th>

         <th align="left"><div align="center"><strong><span class="pbodyemp">Market <br />

           Area</span></strong></div></th>

         <th align="left"><strong><span class="pbodyemp"><span class="style1">Benchmark</span><br />

           Average</span></strong></th>

         <th align="left"><strong><span class="pbodyemp">Index</span></strong></th>
       ...
       <tr class="pbodyemp">
         ...
         <th align="left" >Purchase of last vehicle</th>

         <th align="left"><div align="center">Market <br />
...
<div class="print_pages align="left""> 
    ...
    <td height="69" colspan="2" ><table width="100%" border="0" cellspacing="4" cellpadding="4">
      ...
      <tr>
       ...
       <td width="132" height="65" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
        ...
        <td width="43%" align="right" class="pheading">Competition</td>
  ...
  <td width="50%" valign="top" ><table width="95%"  align="center" cellpadding="1" cellspacing="1" class="pbody12">
    <tr class="table table-hover table-bordered">
      <td class="pbodyemp"><div align="center" class="style3">
        <table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" class="pbody12">
          <tr class="pbodyemp">
            <th width="150" align="left">Specific Manufacturer <br />
              (Domestic)</th>
            <th width="100" align="left"><div align="center">Market <br />
              Area</div></th>
...
<div class="print_pages align="left""> 
  ...
  <tr>
    ...
    <td width="132" height="65" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
        ...
        <td width="43%" align="right" class="pheading">Intend to Buy</td>
  ...
  <td width="50%" valign="top" ><table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" class="pbody12">
    ...
    <tr class="pbodyemp">
      ...
      <th width="150" align="left">Intend to buy</th>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>Definitely will purchase</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>Likely will purchase</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>Likely will not purchase</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>Definitely will not purchase</span></td>
    ...
    <tr class="pbodyemp">
      ...
      <th align="center">Value of vehicle intend to buy</th>

      <th align="center">Market <br />

        Area</th>

      <th align="center"><span class="style1">Benchmark</span><br />
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>Less than $10,000</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$10,000 - $14,999</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$15,000 - $19,999</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$20,000 - $24,999</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$25,000 - $29,999</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$30,000 - $39,999</span></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td><span class="pbody12" style="padding-left:14px";>$40,000 or more</span></td>
    ...
    <tr class="pbodyemp">
      ...
      <th align="left" class="">Type of vehicle intend to buy</th>

      <th align="left" class=""><div align="center">Market <br />

        Area</div></th>

      <th align="left" class=""><div align="center"><span class="style1">Benchmark</span><br />
  ...
  <td width="50%" align="center" valign="top" ><img src="kids_car.jpg" alt="kids car" width="425" height="425" class="Example_E1" /><span class="pbody12">Market area compared to 
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
...
<div class="print_pages_last last_page align="left""> 
  ...
  <tr>
    ...
    <td height="67" colspan="2" ><table width="100%" border="0" cellspacing="4" cellpadding="4">
     ...
     <td width="132" height="65" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST" /></td>
        ...
        <td width="43%" align="right" class="pheading">After Market</td>
  ...
  <td width="50%" valign="top" ><table width="95%" border="1" align="center" cellpadding="1" cellspacing="1" class="pbody12">
    ...
    <tr class="pbodyemp">
      ...
      <th width="166" align="center">Most recent visited service centre</th>

      <th width="71" align="left"><div align="center">Market <br />

        Area</div></th>

      <th width="95" align="left"><div align="center"><span class="style1">Benchmark</span><br />

        Average</div></th>

      <th width="68" align="left"><div align="center">Index</div></th>
  ...
  <td width="50%" align="center" valign="top" ><table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
    ...
    <tr class="pbodyemp">
      ...
      <th width="150" align="center">Visited gas station</th>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASCT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASCT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASCT);?></div></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASCR,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASCR,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASCR);?></div></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASES,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASES,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASES);?></div></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASPT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASPT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASPT);?></div></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASSL,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASSL,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASSL);?></div></td>
    ...
    <tr class="table table-hover table-bordered">
      ...
      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($pAU_GASOT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($cAU_GASOT,1);?>%</div></td>

      <td class="pbodyemp"><div align="center" class="style3"><?php echo number_format($iAU_GASOT);?></div></td>

    </tr>

  </table>

    <br />    <img src="gas.jpg" alt="gas" width="440" height="220" class="Example_E1" /><span class="pbody12">Market area compared to 
<?php echo $tbench_store_number . " " . $tbench_store_name; ?></span></td>
