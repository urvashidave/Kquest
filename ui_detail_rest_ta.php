...
.tgdr { page-break-before: avoid !important }
...
<tr>
<td width="900" colspan="2" align="center" valign="middle" class="blue22"><p class="blue22"><strong class="stitle">
  <!--to put message here  -->
  <?php 
...
<div class="noprint"> <br /></div>
<div class="pagebreak"></div>
<div class="print_pages1 last_page" align="left">
  <td><table width="900" height="214" border="0" cellspacing="0" cellpadding="6">
    <tr>
      <td height="70" colspan="2" padding-right:="padding-right:"""><table width="890" height="62"border="0" cellspacing="" cellpadding="4">
        <tr>
