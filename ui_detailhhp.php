...
$all_agehomes1['homes'] = $demo['agehomes'][2] + $demo['agehomes'][3] + $demo['agehomes'][4] + $demo['agehomes'][5];

$all_agehomes['apts'] = $demo['agehomes'][8] + $demo['agehomes'][9] + $demo['agehomes'][10] + $demo['agehomes'][11] + $demo['agehomes'][12] + $demo['agehomes'][13];
$all_agehomes1['apts'] = $demo['agehomes'][10] + $demo['agehomes'][11] + $demo['agehomes'][12] + $demo['agehomes'][13];
...
if($all_agehomes['dwellings'] >0) {
	...
	$all_agehomes1['homesp'] = $all_agehomes1['homes'] / $all_agehomes['dwellings'] *100;
	$all_agehomes1['aptsp'] = $all_agehomes1['apts'] / $all_agehomes['dwellings'] *100;
}
else {
	for ($i=0; $i < 14; $i++) {
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <div style="width:100%; text-align:center; margin: 10px 0; position: relative;">
 	...
 	<span class="pbody12">Target Audience compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span>
 ...
 <td width="50%" height="482" align="center" valign="top" class="style12"><br />
   ...
   <table width="300" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
       ...
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON_60*3,0);?>" height="20" alt="age" /><?php echo "&nbsp &nbsp".number_format($pDW_CON_60,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">1961 to 1980</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON6180*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON6180,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">1981 to 1990</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON8190*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON8190,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">1991 to 2000</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON9100*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON9100,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">2001 to 2005</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON0105*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON0105,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">2006 to 2011</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON0611*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON0611,1);?>%</td>
     </tr>
     <tr>
       <td class="style12">2012 and newer</td>
       <td class="style12"><img src="green5.png" width="<?php echo number_format($pDW_CON12_*3,0);?>" height="20" alt="age" />
       <?php echo "&nbsp &nbsp".number_format($pDW_CON12_,1);?>%</td>
     </tr>
     <tr>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
  ...
  <div style="width:100%; text-align:center; margin: 3px 0;"> <span class="pbody12">Target Audience compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span> </div>
</div>
<div class="pagebreak"> </div>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <tr class="style12">
   ...
   <td style="">Private Dwellings analyzed</td>
 ...
 <td style="">Average Dwelling Value</td>
 ...
 <tr >
   ...
   <th style=""><strong><span class="pbodyemp">Dwelling Style</span></strong></th>
   
   <th style=""><div align="center"><span class="sgrey14">Target Audience</span></div></th>
   
   <th style=""><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>
   
   <th style=""><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
   
 </tr>

 <tr class="style12"><td style="">Single-detached house</td><td align="center"><?php echo number_format($pDW_SINGLE,1);?>%</td><td align="center"><?php echo number_format($cDW_SINGLE,1);?>%</td><td align="center"><?php echo number_format($iDW_SINGLE);?></td></tr>

 <tr class="style12">

 <td style="">&lt;5 story building</td>
 ...
 <tr class="style12"><td style="">5+ story building</td><td align="center"><?php echo number_format($pDW_APT5_,1);?>%</td><td align="center"><?php echo number_format($cDW_APT5_,1);?>%</td><td align="center"><?php echo number_format($iDW_APT5_);?></td></tr>

 <tr class="style12">

 <td style="">Semi-detached house</td>
 ...
 <tr class="style12"><td style="">Other dwelling</td><td align="center"><?php echo number_format($pother_homes,1);?>%</td><td align="center"><?php echo number_format($cother_homes,1);?>%</td><td align="center"><?php echo number_format($iother_homes);?></td></tr>
...
** 
 ...
 <td width="51%" valign="top" ><table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
   <tr >
     <th width="155" style=""><strong><span class="pbodyemp">Period of Construction </span></strong></th>
     <th width="106" style=""><div align="center"><span class="sgrey14">Target Audience</span></div></th>
     <th width="77" style=""><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>
     <th width="63" style=""><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
   </tr>
   <tr class="style12">
     <td style="">1960 or before</td>
   ...
   <table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
     <tr >
       <th width="155" style=""><strong><span class="pbodyemp">Newly Building Developments </span></strong></th>
     ...
     <tr class="style12">
       <td style="">2013</td>
       <td align="center"><?php echo number_format($demo['agehomes'][2],0) . " (". number_format($agehomes['percent'][2],1) . "%)";?></td>
       <td align="center"><?php echo number_format($demo['agehomes'][10],0) . " (". number_format($agehomes['percent'][10],1) . "%)";?></td>
       <td align="center"><?php echo number_format(($demo['agehomes'][2]+$demo['agehomes'][10]));?></td>
     </tr>
     <tr class="style12">
       <td style="">2014</td>
       <td align="center"><?php echo number_format($demo['agehomes'][3],0) . " (". number_format($agehomes['percent'][3],1) . "%)";?></td>
       <td align="center"><?php echo number_format($demo['agehomes'][11],0) . " (". number_format($agehomes['percent'][11],1) . "%)";?></td>
       <td align="center"><?php echo number_format(($demo['agehomes'][3]+$demo['agehomes'][11]));?></td>
     </tr>
     <tr class="style12">
       <td style="">2015</td>
       <td align="center"><?php echo number_format($demo['agehomes'][4],0) . " (". number_format($agehomes['percent'][4],1) . "%)";?></td>
       <td align="center"><?php echo number_format($demo['agehomes'][12],0) . " (". number_format($agehomes['percent'][12],1) . "%)";?></td>
       <td align="center"><?php echo number_format(($demo['agehomes'][4]+$demo['agehomes'][12]));?></td>
     </tr>
     <tr class="style12">
       <td style="">2016</td>
       <td align="center"><?php echo number_format($demo['agehomes'][5],0) . " (". number_format($agehomes['percent'][5],1) . "%)";?></td>
       <td align="center"><?php echo number_format($demo['agehomes'][13],0) . " (". number_format($agehomes['percent'][13],1) . "%)";?></td>
       <td align="center"><?php echo number_format(($demo['agehomes'][5]+$demo['agehomes'][13]));?></td>
     </tr>
     <tr class="style12">
       <td style=""><strong>Total</strong></td>
       <td align="center"><strong><?php echo number_format($all_agehomes['homes'],0) . " (". number_format($all_agehomes['homesp'],1) . "%)";?></strong></td>
       <td align="center"><strong><?php echo number_format($all_agehomes['apts'],0) . " (". number_format($all_agehomes['aptsp'],1) . "%)";?></strong></td>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
    ...
    <tr>
      <td width="51%" valign="top" ><table width="95%" border="1" cellpadding="1" cellspacing="1" class="pbody12">
        <tr >
          <th width="155" style="";><strong><span class="pbodyemp"> Dwelling Maintenance</span></strong></th>
          <th width="106" style="";><div align="center"><span class="sgrey14">Target Audience</span></div></th>
          <th width="77" style="";><div align="center"><strong><span class="pbodyemp">benchamrk<br />
            Average</span></strong></div></th>
          <th width="63" style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
          </tr>
        <tr class="style12">
          <td style="";>Dwelling requires minor repairs only</td>
        ...
        <tr class="style12">
          <td style="";>Dwelling requires a major repair(s)</td>
        ...
        <tr >
          <th style="";><strong><span class="pbodyemp">Residing at current location</span></strong></th>
          <th style="";><div align="center"><span class="sgrey14">Target Audience</span></div></th>
          <th style="";><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>
          <th style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
          </tr>
        <tr class="style12">
          <td style="";>Less than 1 year</td>
        ...
        <tr >
          <th style="";><strong><span class="pbodyemp">Spending on Renovations (past 2 years)</span></strong></th>
          <th style="";><div align="center"><span class="sgrey14">Target Audience</span></div></th>
          <th style="";><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>
          <th style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
          </tr>
  ...
  <div style="width:100%; text-align:center; margin: 10px 0;"> <span class="pbody12">Market area compared to <?php echo $tbench_store_number . " " . $tbench_store_name; ?></span> </div>
</div>
<div class="pagebreak"> </div>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <th style="";>Renovation Projects<br />

 past 2 years</th>

 <th width="75" style="";><div align="center"><span class="sgrey14">Target Audience</span></div></th>

 <th width="75" style="";><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>
 ...
 <td style="";>Added living space</td>
 ...
 <td style="";>Built/renovated a garage</td>
 ...
 <td style="";>Custom draperies/curtains</td>
 ...
 <td style="";>Energy conservation projects (any)</td>
 ...
 <td style="";>Exterior painting/staining</td>
 ...
 <td style="";>Floor tiles or vinyl flooring</td>
 ...
 <td style="";>Hardwood/Laminate Flooring</td>
 ...
 <td style="";>Heating, ventilation, or air conditioning</td>
 ...
 <td style="";>Installed home security system</td>
 ...
 <td style="";>Installed windows or doors</td>
 ...
 <td style="";>Interior painting/wallpaper</td>
 ...
 <td style="";>Landscaping or yard improvements</td>
 ...
 <td style="";>Remodelled bathroom</td>
 ...
 <td style="";>Remodelled kitchen</td>
 ...
 <td style="";>Remodelled other room(s)</td>
 ...
 <td style="";>Swimming pools/spas</td>
 ...
 <td style="";>Wall-to-wall carpet or rugs</td>
 ...
 <td style="";>Other home project(s)</td>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <th style="";><strong><span class="pbodyemp">Renovations (past 2 years)</span></strong></th>
 ...
 <td style="";>Added living space-myself, family or friend</td>
 ...
 <td style="";>Added living space-Contractor/tradesperson</td>
 ...
 <td style="";>Built/renovated a garage-Myself, family or friend</td>
 ...
 <td style="";>Built/renovated a garage-Contractor/tradesperson</td>
 ...
 <td style="";>Custom draperies/curtains-myself, family or friend</td>
 ...
 <td style="";>Custom draperies/curtains-Contractor/tradesperson</td>
 ...
 <td style="";>Deck/fencing-myself, family or friend</td>
 ...
 <td style="";>Deck/fencing-Contractor/tradesperson</td>
 ...
 <td style="";>Electrical-myself, family or friend</td>
 ...
 <td style="";>Electrical-Contractor/tradesperson</td>
 ...
 <td style="";>Energy conservation projects-myself, family or friend</td>
 ...
 <td style="";>Energy conservation projects-Contractor/tradesperson</td>
 ...
 <th width="182" style="";><strong><span class="pbodyemp">Renovations (past 2 years)</span></strong></th>

 <th width="75" style="";><div align="center"><strong><span class="pbodyemp">Target Audience</span></strong></div></th>

 <th width="75" style="";><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>

 <th width="80" style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>
 ...
 <td style="";>Exterior painting/staining-myself, family or friend</td>
 ...
 <td style="";>Exterior painting/staining-Contractor/tradesperson</td>
 ...
 <td style="";>Floor tiles or vinyl flooring-myself, family or friend</td>
 ...
 <td style="";>Floor tiles or vinyl flooring-Contractor/tradesperson</td>
 ...
 <td style="";>Hardwood/Laminate Flooring by myself, family or friend</td>
 ...
 <td style="";>Hardwood/Laminate Flooring by Contractor/tradesperson</td>
 ...
 <td style="";>Heating, ventilation, or air con... by myself, family or friend</td>
 ...
 <td style="";>Heating, ventilation, or air con... by Contractor/tradesperson</td>
 ...
 <td style="";>Installed home security system by myself, family or friend</td>
 ...
 <td style="";>Installed home security system by Contractor/tradesperson</td>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <th width="65" style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>

 </tr>

 <tr class="style12">

 <td style="";>Installed windows or doors by myself, family or friend</td>
 ...
 <td style="";>Installed windows or doors by Contractor/tradesperson</td>
 ...
 <td style="";>Interior painting/wallpaper by myself, family or friend</td>
 ...
 <td style="";>Interior painting/wallpaper by Contractor/tradesperson</td>
 ...
 <td style="";>Landscaping or yard improvements by myself, family or friend</td>
 ...
 <td style="";>Landscaping or yard improvements by Contractor/tradesperson</td>
 ...
 <td style="";>Plumbing (any jobs) by myself, family or friend</td>
 ...
 <td style="";>Plumbing (any jobs) by Contractor/tradesperson</td>
 ...
 <td style="";>Remodelled bathroom by myself, family or friend</td>
 ...
 <td style="";>Remodelled bathroom by Contractor/tradesperson</td>
 ...
 <td style="";>Remodelled kitchen by myself, family or friend</td>
 ...
 <td style="";>Remodelled kitchen by Contractor/tradesperson</td>
 ...
 <td style="";>Remodelled other room(s) by myself, family or friend</td>
 ...
 <td style="";>Remodelled other room(s) by Contractor/tradesperson</td>
 ...
 <td style="";>Roofing by myself, family or friend</td>
 ...
 <td style="";>Roofing by Contractor/tradesperson</td>
 ...
 <td style="";>Swimming pools/spas by myself, family or friend</td>
 ...
 <td style="";>Swimming pools/spas by Contractor/tradesperson</td>
 ...
 <td style="";>Wall to wall carpet or rugs by myself, family or friend</td>
 ...
 <td style="";>Wall to wall carpet or rugs by Contractor/tradesperson</td>
 ...
 <td style="";>Other home project(s) by myself, family or friend</td>
 ...
 <td style="";>Other home project(s) by Contractor/tradesperson</td>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <th width="236" style="";><strong><span class="pbodyemp">Shoppers by Retailer</span></strong></th>

 <th width="119" style="";><div align="center"><strong><span class="pbodyemp">Target Audience</span></strong></div></th>

 <th width="83" style="";><div align="center"><strong><span class="pbodyemp">Benchmark</span></strong></div></th>

 <th width="67" style="";><div align="center"><strong><span class="pbodyemp">Index</span></strong></div></th>

 </tr>

 <tr class="style4"><td style="";>Canadian Tire</td><td align="center"><?php echo number_format($pH_CANTR,1);?>%</td><td align="center"><?php echo number_format($cH_CANTR,1);?>%</td><td align="center"><?php echo number_format($iH_CANTR);?></td></tr>

 <tr class="style4"><td style="";>Home Depot</td><td align="center"><?php echo number_format($pH_DEPOT,1);?>%</td><td align="center"><?php echo number_format($cH_DEPOT,1);?>%</td><td align="center"><?php echo number_format($iH_DEPOT);?></td></tr>

 <tr class="style4"><td style="";>Home Hardware</td><td align="center"><?php echo number_format($pH_HWARE,1);?>%</td><td align="center"><?php echo number_format($cH_HWARE,1);?>%</td><td align="center"><?php echo number_format($iH_HWARE);?></td></tr>

 <tr class="style4"><td style="";>Home Outfitters</td><td align="center"><?php echo number_format($pH_OUTFT,1);?>%</td><td align="center"><?php echo number_format($cH_OUTFT,1);?>%</td><td align="center"><?php echo number_format($iH_OUTFT);?></td></tr>

 <tr class="style4"><td style="";>Home Sense</td><td align="center"><?php echo number_format($pH_SENSE,1);?>%</td><td align="center"><?php echo number_format($cH_SENSE,1);?>%</td><td align="center"><?php echo number_format($iH_SENSE);?></td></tr>

 <tr class="style4"><td style="";>Independent hardware stores (any)</td><td align="center"><?php echo number_format($pH_INDEP,1);?>%</td><td align="center"><?php echo number_format($cH_INDEP,1);?>%</td><td align="center"><?php echo number_format($iH_INDEP);?></td></tr>

 <tr class="style4"><td style="";>Lee Valley Tools</td><td align="center"><?php echo number_format($pH_LEE,1);?>%</td><td align="center"><?php echo number_format($cH_LEE,1);?>%</td><td align="center"><?php echo number_format($iH_LEE);?></td></tr>

 <tr class="style4"><td style="";>Lighting stores (any)</td><td align="center"><?php echo number_format($pH_LIGHT,1);?>%</td><td align="center"><?php echo number_format($cH_LIGHT,1);?>%</td><td align="center"><?php echo number_format($iH_LIGHT);?></td></tr>

 <tr class="style4"><td style="";>Lowe's Home Improvement</td><td align="center"><?php echo number_format($pH_LOWE,1);?>%</td><td align="center"><?php echo number_format($cH_LOWE,1);?>%</td><td align="center"><?php echo number_format($iH_LOWE);?></td></tr>

 <tr class="style4"><td style="";>Rona Stores (any)</td><td align="center"><?php echo number_format($pH_RONA,1);?>%</td><td align="center"><?php echo number_format($cH_RONA,1);?>%</td><td align="center"><?php echo number_format($iH_RONA);?></td></tr>

 <tr class="style4"><td style="";>Department stores (any)</td><td align="center"><?php echo number_format($pH_DEPT,1);?>%</td><td align="center"><?php echo number_format($cH_DEPT,1);?>%</td><td align="center"><?php echo number_format($iH_DEPT);?></td></tr>

 <tr class="style4"><td style="";>Online Home Improvement stores</td><td align="center"><?php echo number_format($pH_OL,1);?>%</td><td align="center"><?php echo number_format($cH_OL,1);?>%</td><td align="center"><?php echo number_format($iH_OL);?></td></tr>

 <tr class="style4"><td style="";>Other Home Décor stores</td><td align="center"><?php echo number_format($pH_OTHDEC,1);?>%</td><td align="center"><?php echo number_format($cH_OTHDEC,1);?>%</td><td align="center"><?php echo number_format($iH_OTHDEC);?></td></tr>

 <tr class="style4"><td style="";>Other Home Improvement stores</td><td align="center"><?php echo number_format($pH_OTHIMP,1);?>%</td><td align="center"><?php echo number_format($cH_OTHIMP,1);?>%</td><td align="center"><?php echo number_format($iH_OTHIMP);?></td></tr>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <tr class="style4"><td style="";>Canadian Tire</td><td align="center"><?php echo number_format($pH_CANTR_R,1);?>%</td><td align="center"><?php echo number_format($cH_CANTR_R,1);?>%</td><td align="center"><?php echo number_format($iH_CANTR_R);?></td></tr>

 <tr class="style4"><td style="";>Home Depot</td><td align="center"><?php echo number_format($pH_DEPOT_R,1);?>%</td><td align="center"><?php echo number_format($cH_DEPOT_R,1);?>%</td><td align="center"><?php echo number_format($iH_DEPOT_R);?></td></tr>

 <tr class="style4"><td style="";>Home Hardware</td><td align="center"><?php echo number_format($pH_HWARE_R,1);?>%</td><td align="center"><?php echo number_format($cH_HWARE_R,1);?>%</td><td align="center"><?php echo number_format($iH_HWARE_R);?></td></tr>

 <tr class="style4"><td style="";>Home Outfitters</td><td align="center"><?php echo number_format($pH_OUTFT_R,1);?>%</td><td align="center"><?php echo number_format($cH_OUTFT_R,1);?>%</td><td align="center"><?php echo number_format($iH_OUTFT_R);?></td></tr>

 <tr class="style4"><td style="";>Home Sense</td><td align="center"><?php echo number_format($pH_SENSE_R,1);?>%</td><td align="center"><?php echo number_format($cH_SENSE_R,1);?>%</td><td align="center"><?php echo number_format($iH_SENSE_R);?></td></tr>

 <tr class="style4"><td style="";>Independent hardware stores (any)</td><td align="center"><?php echo number_format($pH_INDEP_R,1);?>%</td><td align="center"><?php echo number_format($cH_INDEP_R,1);?>%</td><td align="center"><?php echo number_format($iH_INDEP_R);?></td></tr>

 <tr class="style4"><td style="";>Lee Valley Tools</td><td align="center"><?php echo number_format($pH_LEE_R,1);?>%</td><td align="center"><?php echo number_format($cH_LEE_R,1);?>%</td><td align="center"><?php echo number_format($iH_LEE_R);?></td></tr>

 <tr class="style4"><td style="";>Lighting stores (any)</td><td align="center"><?php echo number_format($pH_LIGHT_R,1);?>%</td><td align="center"><?php echo number_format($cH_LIGHT_R,1);?>%</td><td align="center"><?php echo number_format($iH_LIGHT_R);?></td></tr>

 <tr class="style4"><td style="";>Lowe's Home Improvement</td><td align="center"><?php echo number_format($pH_LOWE_R,1);?>%</td><td align="center"><?php echo number_format($cH_LOWE_R,1);?>%</td><td align="center"><?php echo number_format($iH_LOWE_R);?></td></tr>

 <tr class="style4"><td style="";>Rona Stores (any)</td><td align="center"><?php echo number_format($pH_RONA_R,1);?>%</td><td align="center"><?php echo number_format($cH_RONA_R,1);?>%</td><td align="center"><?php echo number_format($iH_RONA_R);?></td></tr>

 <tr class="style4"><td style="";>Department stores (any)</td><td align="center"><?php echo number_format($pH_DEPT_R,1);?>%</td><td align="center"><?php echo number_format($cH_DEPT_R,1);?>%</td><td align="center"><?php echo number_format($iH_DEPT_R);?></td></tr>

 <tr class="style4"><td style="";>Online Home Improvement stores</td><td align="center"><?php echo number_format($pH_OL_R,1);?>%</td><td align="center"><?php echo number_format($cH_OL_R,1);?>%</td><td align="center"><?php echo number_format($iH_OL_R);?></td></tr>

 <tr class="style4"><td style="";>Other Home Décor stores</td><td align="center"><?php echo number_format($pH_OTHDEC_R,1);?>%</td><td align="center"><?php echo number_format($cH_OTHDEC_R,1);?>%</td><td align="center"><?php echo number_format($iH_OTHDEC_R);?></td></tr>

 <tr class="style4"><td style="";>Other Home Improvement stores</td><td align="center"><?php echo number_format($pH_OTHIMP_R,1);?>%</td><td align="center"><?php echo number_format($cH_OTHIMP_R,1);?>%</td><td align="center"><?php echo number_format($iH_OTHIMP_R);?></td></tr>
 ...
 <tr class="style4"><td style="";>Canadian Tire</td><td align="center"><?php echo number_format($pH_CANTR_O,1);?>%</td><td align="center"><?php echo number_format($cH_CANTR_O,1);?>%</td><td align="center"><?php echo number_format($iH_CANTR_O);?></td></tr>

 <tr class="style4"><td style="";>Home Depot</td><td align="center"><?php echo number_format($pH_DEPOT_O,1);?>%</td><td align="center"><?php echo number_format($cH_DEPOT_O,1);?>%</td><td align="center"><?php echo number_format($iH_DEPOT_O);?></td></tr>

 <tr class="style4"><td style="";>Home Hardware</td><td align="center"><?php echo number_format($pH_HWARE_O,1);?>%</td><td align="center"><?php echo number_format($cH_HWARE_O,1);?>%</td><td align="center"><?php echo number_format($iH_HWARE_O);?></td></tr>

 <tr class="style4"><td style="";>Home Outfitters</td><td align="center"><?php echo number_format($pH_OUTFT_O,1);?>%</td><td align="center"><?php echo number_format($cH_OUTFT_O,1);?>%</td><td align="center"><?php echo number_format($iH_OUTFT_O);?></td></tr>

 <tr class="style4"><td style="";>Home Sense</td><td align="center"><?php echo number_format($pH_SENSE_O,1);?>%</td><td align="center"><?php echo number_format($cH_SENSE_O,1);?>%</td><td align="center"><?php echo number_format($iH_SENSE_O);?></td></tr>

 <tr class="style4"><td style="";>Independent hardware stores (any)</td><td align="center"><?php echo number_format($pH_INDEP_O,1);?>%</td><td align="center"><?php echo number_format($cH_INDEP_O,1);?>%</td><td align="center"><?php echo number_format($iH_INDEP_O);?></td></tr>

 <tr class="style4"><td style="";>Lee Valley Tools</td><td align="center"><?php echo number_format($pH_LEE_O,1);?>%</td><td align="center"><?php echo number_format($cH_LEE_O,1);?>%</td><td align="center"><?php echo number_format($iH_LEE_O);?></td></tr>

 <tr class="style4"><td style="";>Lighting stores (any)</td><td align="center"><?php echo number_format($pH_LIGHT_O,1);?>%</td><td align="center"><?php echo number_format($cH_LIGHT_O,1);?>%</td><td align="center"><?php echo number_format($iH_LIGHT_O);?></td></tr>

 <tr class="style4"><td style="";>Lowe's Home Improvement</td><td align="center"><?php echo number_format($pH_LOWE_O,1);?>%</td><td align="center"><?php echo number_format($cH_LOWE_O,1);?>%</td><td align="center"><?php echo number_format($iH_LOWE_O);?></td></tr>

 <tr class="style4"><td style="";>Rona Stores (any)</td><td align="center"><?php echo number_format($pH_RONA_O,1);?>%</td><td align="center"><?php echo number_format($cH_RONA_O,1);?>%</td><td align="center"><?php echo number_format($iH_RONA_O);?></td></tr>

 <tr class="style4"><td style="";>Department stores (any)</td><td align="center"><?php echo number_format($pH_DEPT_O,1);?>%</td><td align="center"><?php echo number_format($cH_DEPT_O,1);?>%</td><td align="center"><?php echo number_format($iH_DEPT_O);?></td></tr>

 <tr class="style4"><td style="";>Online Home Improvement stores</td><td align="center"><?php echo number_format($pH_OL_O,1);?>%</td><td align="center"><?php echo number_format($cH_OL_O,1);?>%</td><td align="center"><?php echo number_format($iH_OL_O);?></td></tr>

 <tr class="style4"><td style="";>Other Home Décor stores</td><td align="center"><?php echo number_format($pH_OTHDEC_O,1);?>%</td><td align="center"><?php echo number_format($cH_OTHDEC_O,1);?>%</td><td align="center"><?php echo number_format($iH_OTHDEC_O);?></td></tr>

 <tr class="style4"><td style="";>Other Home Improvement stores</td><td align="center"><?php echo number_format($pH_OTHIMP_O,1);?>%</td><td align="center"><?php echo number_format($cH_OTHIMP_O,1);?>%</td><td align="center"><?php echo number_format($iH_OTHIMP_O);?></td></tr>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <th style="";><strong><span class="pbodyemp">Purchased <br />
 ...
 <tr class="style4"><td style="";>Vacuum cleaners</td><td align="center"><?php echo number_format($pPC_VACUUM,1);?>%</td><td align="center"><?php echo number_format($cPC_VACUUM,1);?>%</td><td align="center"><?php echo number_format($iPC_VACUUM);?></td></tr>
 ...
 <th style="";><strong><span class="pbodyemp">Intend to Buy<br /> 
 ...
 <tr class="style4"><td style="";>Garden/Patio furniture (any)</td><td align="center"><?php echo number_format($pPI_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($cPI_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($iPI_GRPTFUR);?></td></tr>

 <tr class="style4"><td style="";>Gas barbeque</td><td align="center"><?php echo number_format($pPI_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($cPI_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($iPI_GASBBQ);?></td></tr>

 <tr class="style4"><td style="";>Fireplace (any)</td><td align="center"><?php echo number_format($pPI_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($cPI_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($iPI_FIREPLC);?></td></tr>

 <tr class="style4"><td style="";>Major appliances</td><td align="center"><?php echo number_format($pPI_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($cPI_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($iPI_APPLIAN);?></td></tr>

 <tr class="style4"><td style="";>Vacuum cleaners</td><td align="center"><?php echo number_format($pPI_VACUUM,1);?>%</td><td align="center"><?php echo number_format($cPI_VACUUM,1);?>%</td><td align="center"><?php echo number_format($iPI_VACUUM);?></td></tr>
 ...
 <tr class="style4"><td style="";>Garden supplies: Nothing</td><td align="center"><?php echo number_format($pSP_GSNO,1);?>%</td><td align="center"><?php echo number_format($cSP_GSNO,1);?>%</td><td align="center"><?php echo number_format($iSP_GSNO);?></td></tr>

 <tr class="style4"><td style="";>Garden supplies: $1 - $249</td><td align="center"><?php echo number_format($pSP_GS249,1);?>%</td><td align="center"><?php echo number_format($cSP_GS249,1);?>%</td><td align="center"><?php echo number_format($iSP_GS249);?></td></tr>

 <tr class="style4"><td style="";>Garden supplies: $250 - $499</td><td align="center"><?php echo number_format($pSP_GS499,1);?>%</td><td align="center"><?php echo number_format($cSP_GS499,1);?>%</td><td align="center"><?php echo number_format($iSP_GS499);?></td></tr>

 <tr class="style4"><td style="";>Garden supplies: $500 or more</td><td align="center"><?php echo number_format($pSP_GS500,1);?>%</td><td align="center"><?php echo number_format($cSP_GS500,1);?>%</td><td align="center"><?php echo number_format($iSP_GS500);?></td></tr>
 ...
 <td style="";>Home décor: Nothing</td><td align="center"><?php echo number_format($pSP_HDNO,1);?>%</td><td align="center"><?php echo number_format($cSP_HDNO,1);?>%</td><td align="center"><?php echo number_format($iSP_HDNO);?></td></tr>

 <tr class="style4"><td style="";>Home décor: $1 - $249</td><td align="center"><?php echo number_format($pSP_HD249,1);?>%</td><td align="center"><?php echo number_format($cSP_HD249,1);?>%</td><td align="center"><?php echo number_format($iSP_HD249);?></td></tr>

 <tr class="style4">

 <td style="";>Home décor: $250 - $499</td><td align="center"><?php echo number_format($pSP_HD499,1);?>%</td><td align="center"><?php echo number_format($cSP_HD499,1);?>%</td><td align="center"><?php echo number_format($iSP_HD499);?></td></tr>

 <tr class="style4">

 <td style="";>Home décor: $500 or more</td><td align="center"><?php echo number_format($pSP_HD500,1);?>%</td><td align="center"><?php echo number_format($cSP_HD500,1);?>%</td><td align="center"><?php echo number_format($iSP_HD500);?></td></tr>
 ...
 <td style="";>Power tools: Nothing</td><td align="center"><?php echo number_format($pSP_PTNO,1);?>%</td><td align="center"><?php echo number_format($cSP_PTNO,1);?>%</td><td align="center"><?php echo number_format($iSP_PTNO);?></td></tr>

 <tr class="style4">

 <td style="";>Power tools: $1 - $249</td><td align="center"><?php echo number_format($pSP_PT249,1);?>%</td><td align="center"><?php echo number_format($cSP_PT249,1);?>%</td><td align="center"><?php echo number_format($iSP_PT249);?></td></tr>

 <tr class="style4">

 <td style="";>Power tools: $250 - $499</td><td align="center"><?php echo number_format($pSP_PT499,1);?>%</td><td align="center"><?php echo number_format($cSP_PT499,1);?>%</td><td align="center"><?php echo number_format($iSP_PT499);?></td></tr>

 <tr class="style4">

 <td style="";>Power tools: $500 or more</td><td align="center"><?php echo number_format($pSP_PT500,1);?>%</td><td align="center"><?php echo number_format($cSP_PT500,1);?>%</td><td align="center"><?php echo number_format($iSP_PT500);?></td></tr>
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <tr class="style12"><td style="";>Baby furniture</td><td align="center"><?php echo number_format($pPC_BBFUR,1);?>%</td><td align="center"><?php echo number_format($cPC_BBFUR,1);?>%</td><td align="center"><?php echo number_format($iPC_BBFUR);?></td></tr>

 <tr class="style12"><td style="";>Bed/mattress</td><td align="center"><?php echo number_format($pPC_BED,1);?>%</td><td align="center"><?php echo number_format($cPC_BED,1);?>%</td><td align="center"><?php echo number_format($iPC_BED);?></td></tr>

 <tr class="style12">

 <td style="";>All other furniture</td><td align="center"><?php echo number_format($pPC_OFFFUR,1);?>%</td><td align="center"><?php echo number_format($cPC_OFFFUR,1);?>%</td><td align="center"><?php echo number_format($iPC_OFFFUR);?></td></tr>

 <tr class="style12"><td style="";>Car alarm/security system</td><td align="center"><?php echo number_format($pPC_CARALRM,1);?>%</td><td align="center"><?php echo number_format($cPC_CARALRM,1);?>%</td><td align="center"><?php echo number_format($iPC_CARALRM);?></td></tr>

 <tr class="style12"><td style="";>Car stereo</td><td align="center"><?php echo number_format($pPC_CARSTR,1);?>%</td><td align="center"><?php echo number_format($cPC_CARSTR,1);?>%</td><td align="center"><?php echo number_format($iPC_CARSTR);?></td></tr>

 <tr class="style12">

 <td style="";>Camera</td><td align="center"><?php echo number_format($pPC_CMRAFLM,1);?>%</td><td align="center"><?php echo number_format($cPC_CMRAFLM,1);?>%</td><td align="center"><?php echo number_format($iPC_CMRAFLM);?></td></tr>

 <tr class="style12"><td style="";>Camping equipment</td><td align="center"><?php echo number_format($pPC_CMPEQP,1);?>%</td><td align="center"><?php echo number_format($cPC_CMPEQP,1);?>%</td><td align="center"><?php echo number_format($iPC_CMPEQP);?></td></tr>

 <tr class="style12"><td style="";>Camping trailer/Motorhome</td><td align="center"><?php echo number_format($pPC_CMPTRL,1);?>%</td><td align="center"><?php echo number_format($cPC_CMPTRL,1);?>%</td><td align="center"><?php echo number_format($iPC_CMPTRL);?></td></tr>

 <tr class="style12">

 <td style="";>e-Reader </td><td align="center"><?php echo number_format($pPC_EREADER,1);?>%</td><td align="center"><?php echo number_format($cPC_EREADER,1);?>%</td><td align="center"><?php echo number_format($iPC_EREADER);?></td></tr>

 <tr class="style12">

 <td style="";>Garden/Patio furniture </td><td align="center"><?php echo number_format($pPC_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($cPC_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($iPC_GRPTFUR);?></td></tr>

 <tr class="style12"><td style="";>Gas barbeque</td><td align="center"><?php echo number_format($pPC_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($cPC_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($iPC_GASBBQ);?></td></tr>

 <tr class="style12"><td style="";>Fireplace (any)</td><td align="center"><?php echo number_format($pPC_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($cPC_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($iPC_FIREPLC);?></td></tr>

 <tr class="style12"><td style="";>GPS (Handheld or Car)</td><td align="center"><?php echo number_format($pPC_GPS,1);?>%</td><td align="center"><?php echo number_format($cPC_GPS,1);?>%</td><td align="center"><?php echo number_format($iPC_GPS);?></td></tr>

 <tr class="style12"><td style="";>Golf equipment</td><td align="center"><?php echo number_format($pPC_GOLFEQP,1);?>%</td><td align="center"><?php echo number_format($cPC_GOLFEQP,1);?>%</td><td align="center"><?php echo number_format($iPC_GOLFEQP);?></td></tr>

 <tr class="style12"><td style="";>Hockey equipment</td><td align="center"><?php echo number_format($pPC_HOCKEY,1);?>%</td><td align="center"><?php echo number_format($cPC_HOCKEY,1);?>%</td><td align="center"><?php echo number_format($iPC_HOCKEY);?></td></tr>

 <tr class="style12"><td style="";>Hot tub/spa</td><td align="center"><?php echo number_format($pPC_HOTTUB,1);?>%</td><td align="center"><?php echo number_format($cPC_HOTTUB,1);?>%</td><td align="center"><?php echo number_format($iPC_HOTTUB);?></td></tr>

 <tr class="style12"><td style="";>Home exercise equipment</td><td align="center"><?php echo number_format($pPC_EXCEQP,1);?>%</td><td align="center"><?php echo number_format($cPC_EXCEQP,1);?>%</td><td align="center"><?php echo number_format($iPC_EXCEQP);?></td></tr>

 <tr class="style12">

 <td style="";>Major appliances </td><td align="center"><?php echo number_format($pPC_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($cPC_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($iPC_APPLIAN);?></td></tr>
 ...
 <td style="";>Musical instrument</td>
 ...
 <td style="";>Portable MP3 player</td>
 ...
 <td style="";>Pool (above or in-ground)</td>
 ...
 <td style="";>Pre-arranged funeral service</td>
 ...
 <td style="";>Ski/snowboard equipment</td>
 ...
 <td style="";>Wedding services (any)</td>
...
<div class=" print_pages buy" align="center" style="height: 625px">
...
<div style=" color: #900C3F;float:left !important; margin-left: 5px;" class="tooltip1 pbody">
 ...
 <tr class="style12"><td style="";>Baby furniture</td><td align="center"><?php echo number_format($pPI_BBFUR,1);?>%</td><td align="center"><?php echo number_format($cPI_BBFUR,1);?>%</td><td align="center"><?php echo number_format($iPI_BBFUR);?></td></tr>

 <tr class="style12"><td style="";>Bed/mattress</td><td align="center"><?php echo number_format($pPI_BED,1);?>%</td><td align="center"><?php echo number_format($cPI_BED,1);?>%</td><td align="center"><?php echo number_format($iPI_BED);?></td></tr>

 <tr class="style12"><td style="";>All other furniture </td><td align="center"><?php echo number_format($pPI_OFFFUR,1);?>%</td><td align="center"><?php echo number_format($cPI_OFFFUR,1);?>%</td><td align="center"><?php echo number_format($iPI_OFFFUR);?></td></tr>

 <tr class="style12"><td style="";>Car alarm/security system</td><td align="center"><?php echo number_format($pPI_CARALRM,1);?>%</td><td align="center"><?php echo number_format($cPI_CARALRM,1);?>%</td><td align="center"><?php echo number_format($iPI_CARALRM);?></td></tr>

 <tr class="style12"><td style="";>Car stereo</td><td align="center"><?php echo number_format($pPI_CARSTR,1);?>%</td><td align="center"><?php echo number_format($cPI_CARSTR,1);?>%</td><td align="center"><?php echo number_format($iPI_CARSTR);?></td></tr>

 <tr class="style12"><td style="";>Camera </td><td align="center"><?php echo number_format($pPI_CMRAFLM,1);?>%</td><td align="center"><?php echo number_format($cPI_CMRAFLM,1);?>%</td><td align="center"><?php echo number_format($iPI_CMRAFLM);?></td></tr>

 <tr class="style12"><td style="";>Camping equipment</td><td align="center"><?php echo number_format($pPI_CMPEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_CMPEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_CMPEQP);?></td></tr>

 <tr class="style12"><td style="";>Camping trailer/Motorhome</td><td align="center"><?php echo number_format($pPI_CMPTRL,1);?>%</td><td align="center"><?php echo number_format($cPI_CMPTRL,1);?>%</td><td align="center"><?php echo number_format($iPI_CMPTRL);?></td></tr>

 <tr class="style12"><td style="";>e-Reader</td><td align="center"><?php echo number_format($pPI_EREADER,1);?>%</td><td align="center"><?php echo number_format($cPI_EREADER,1);?>%</td><td align="center"><?php echo number_format($iPI_EREADER);?></td></tr>

 <tr class="style12"><td style="";>Garden/Patio furniture </td><td align="center"><?php echo number_format($pPI_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($cPI_GRPTFUR,1);?>%</td><td align="center"><?php echo number_format($iPI_GRPTFUR);?></td></tr>

 <tr class="style12"><td style="";>Gas barbeque</td><td align="center"><?php echo number_format($pPI_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($cPI_GASBBQ,1);?>%</td><td align="center"><?php echo number_format($iPI_GASBBQ);?></td></tr>

 <tr class="style12"><td style="";>Fireplace (any)</td><td align="center"><?php echo number_format($pPI_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($cPI_FIREPLC,1);?>%</td><td align="center"><?php echo number_format($iPI_FIREPLC);?></td></tr>

 <tr class="style12"><td style="";>GPS (Handheld or Car)</td><td align="center"><?php echo number_format($pPI_GPS,1);?>%</td><td align="center"><?php echo number_format($cPI_GPS,1);?>%</td><td align="center"><?php echo number_format($iPI_GPS);?></td></tr>

 <tr class="style12"><td style="";>Golf equipment</td><td align="center"><?php echo number_format($pPI_GOLFEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_GOLFEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_GOLFEQP);?></td></tr>

 <tr class="style12"><td style="";>Hockey equipment</td><td align="center"><?php echo number_format($pPI_HOCKEY,1);?>%</td><td align="center"><?php echo number_format($cPI_HOCKEY,1);?>%</td><td align="center"><?php echo number_format($iPI_HOCKEY);?></td></tr>

 <tr class="style12"><td style="";>Hot tub/spa</td><td align="center"><?php echo number_format($pPI_HOTTUB,1);?>%</td><td align="center"><?php echo number_format($cPI_HOTTUB,1);?>%</td><td align="center"><?php echo number_format($iPI_HOTTUB);?></td></tr>

 <tr class="style12"><td style="";>Home exercise equipment</td><td align="center"><?php echo number_format($pPI_EXCEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_EXCEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_EXCEQP);?></td></tr>

 <tr class="style12"><td style="";>Major appliances</td><td align="center"><?php echo number_format($pPI_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($cPI_APPLIAN,1);?>%</td><td align="center"><?php echo number_format($iPI_APPLIAN);?></td></tr>

 <tr class="style12"><td style="";>Motorcycle</td><td align="center"><?php echo number_format($pPI_MOTORCY,1);?>%</td><td align="center"><?php echo number_format($cPI_MOTORCY,1);?>%</td><td align="center"><?php echo number_format($iPI_MOTORCY);?></td></tr>
 ...
 <tr class="style12"><td style="";>Musical instrument</td><td align="center"><?php echo number_format($pPI_MINSTR,1);?>%</td><td align="center"><?php echo number_format($cPI_MINSTR,1);?>%</td><td align="center"><?php echo number_format($iPI_MINSTR);?></td></tr>

 <tr class="style12"><td style="";>Office equipment</td><td align="center"><?php echo number_format($pPI_OFFEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_OFFEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_OFFEQP);?></td></tr>

 <tr class="style12"><td style="";>Portable MP3 player</td><td align="center"><?php echo number_format($pPI_MP3,1);?>%</td><td align="center"><?php echo number_format($cPI_MP3,1);?>%</td><td align="center"><?php echo number_format($iPI_MP3);?></td></tr>

 <tr class="style12"><td style="";>Personal computer</td><td align="center"><?php echo number_format($pPI_PC,1);?>%</td><td align="center"><?php echo number_format($cPI_PC,1);?>%</td><td align="center"><?php echo number_format($iPI_PC);?></td></tr>

 <tr class="style12"><td style="";>Computer software</td><td align="center"><?php echo number_format($pPI_PCSW,1);?>%</td><td align="center"><?php echo number_format($cPI_PCSW,1);?>%</td><td align="center"><?php echo number_format($iPI_PCSW);?></td></tr>

 <tr class="style12"><td style="";>Printer</td><td align="center"><?php echo number_format($pPI_PRNT,1);?>%</td><td align="center"><?php echo number_format($cPI_PRNT,1);?>%</td><td align="center"><?php echo number_format($iPI_PRNT);?></td></tr>

 <tr class="style12"><td style="";>Pool (above or in-ground)</td><td align="center"><?php echo number_format($pPI_POOL,1);?>%</td><td align="center"><?php echo number_format($cPI_POOL,1);?>%</td><td align="center"><?php echo number_format($iPI_POOL);?></td></tr>

 <tr class="style12"><td style="";>Pre-arranged funeral service</td><td align="center"><?php echo number_format($pPI_PRAFUNE,1);?>%</td><td align="center"><?php echo number_format($cPI_PRAFUNE,1);?>%</td><td align="center"><?php echo number_format($iPI_PRAFUNE);?></td></tr>

 <tr class="style12"><td style="";>Boat (any)</td><td align="center"><?php echo number_format($pPI_BOAT,1);?>%</td><td align="center"><?php echo number_format($cPI_BOAT,1);?>%</td><td align="center"><?php echo number_format($iPI_BOAT);?></td></tr>

 <tr class="style12"><td style="";>Ski/snowboard equipment</td><td align="center"><?php echo number_format($pPI_SKIEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_SKIEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_SKIEQP);?></td></tr>

 <tr class="style12"><td style="";>Snowmobile/ATV</td><td align="center"><?php echo number_format($pPI_SNOWMBL,1);?>%</td><td align="center"><?php echo number_format($cPI_SNOWMBL,1);?>%</td><td align="center"><?php echo number_format($iPI_SNOWMBL);?></td></tr>

 <tr class="style12"><td style="";>Stereo equipment</td><td align="center"><?php echo number_format($pPI_STEREO,1);?>%</td><td align="center"><?php echo number_format($cPI_STEREO,1);?>%</td><td align="center"><?php echo number_format($iPI_STEREO);?></td></tr>

 <tr class="style12"><td style="";>Television</td><td align="center"><?php echo number_format($pPI_TV,1);?>%</td><td align="center"><?php echo number_format($cPI_TV,1);?>%</td><td align="center"><?php echo number_format($iPI_TV);?></td></tr>

 <tr class="style12"><td style="";>Tires</td><td align="center"><?php echo number_format($pPI_TIRE,1);?>%</td><td align="center"><?php echo number_format($cPI_TIRE,1);?>%</td><td align="center"><?php echo number_format($iPI_TIRE);?></td></tr>

 <tr class="style12"><td style="";>Vacuum cleaners</td><td align="center"><?php echo number_format($pPI_VACUUM,1);?>%</td><td align="center"><?php echo number_format($cPI_VACUUM,1);?>%</td><td align="center"><?php echo number_format($iPI_VACUUM);?></td></tr>

 <tr class="style12"><td style="";>Video equipment</td><td align="center"><?php echo number_format($pPI_VDOEQP,1);?>%</td><td align="center"><?php echo number_format($cPI_VDOEQP,1);?>%</td><td align="center"><?php echo number_format($iPI_VDOEQP);?></td></tr>

 <tr class="style12"><td style="";>Video game system </td><td align="center"><?php echo number_format($pPI_GMSYS,1);?>%</td><td align="center"><?php echo number_format($cPI_GMSYS,1);?>%</td><td align="center"><?php echo number_format($iPI_GMSYS);?></td></tr>

 <tr class="style12"><td style="";>Wedding services (any)</td><td align="center"><?php echo number_format($pPI_WEDSVR,1);?>%</td><td align="center"><?php echo number_format($cPI_WEDSVR,1);?>%</td><td align="center"><?php echo number_format($iPI_WEDSVR);?></td></tr>
