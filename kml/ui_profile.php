...
<input name="report_uid" type="hidden" id="report_uid" value="<?php echo $report_uid*3571; ?>">
  ...
  <tr>
    <td width="900" height="122" align="center" valign="top"><p><span class="pheading"><strong>TARGET 
      AUDIENCE INSIGHTS</strong></span></p>
      <p class="psub2">Store# <?php echo $store_number; ?>, <?php echo $store_name; ?><br>
...
?>
        <br>
        Target Audience <?php echo $var1_fullname_string; ?><br>
        <span class="pbody"><br>
      <?php echo number_format($decile_cutoff*2); ?> target audience households analyzed (out of <?php echo number_format($decile_cutoff*10); ?> households analyzed in the entire market area)</span></p></td>
  </tr>
  <tr >
...
<div class="container row col-md-12 print_pages align="left""> 
  ...
  <tr>
    <td align="center"> <span class="psub2">Household Income</span>      <div id="piechart_3d" style="width: 400px; height: 280px;"></div>
  </td>
    <td align="center"><span class="psub2">Ethnic Diversity</span>      <div id="piechart_3d2" style="width: 400px; height: 280px;"></div></td>
  </tr>
  </table>
</div>
                ...
                <td width="905" height="600" colspan="2"><table width="100%" height="600" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td width="100%" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
                        <td width="48%" align="left" valign="top" class="psub2"><strong class="black18">Store  # <?php echo $store_number; ?></strong><br>
                          <span class="pbody">Target Audience only: <?php echo $var1_fullname_string; ?></span></td>
                        <td width="37%" align="right"><span class="pheading"><strong class="stitle1">SEGMENTATION</strong></span><strong class="stitle1"><br>
                          </strong><a href="segment_descriptions.php" target="_blank" class="pbody">View descriptions</a>  <a class="btn btn-primary btn-sm" onClick="DETAILsubmit_3(<?php echo $report_uid * 3571 ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
                            &nbsp;<strong>View Details</strong>&nbsp;</a></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center"><strong><span class="psub1"><?php echo number_format($segment_counter); ?> Vital segments  identified</span></strong><br>
                      <strong><span class="psub2"><?php echo number_format($vitalsegment_p); ?>% of your target audience and <?php echo number_format($vitalsegment_c); ?>% of your entire market area (index <?php echo number_format($vitalsegment_p / $vitalsegment_c *100); ?>)</span></strong></td>
                  </tr>
                  <tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td width="500" colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="61%" align="left" valign="top" class="black12"><strong class="psub2">Store  # <?php echo $store_number; ?></strong><br>
            Target Audience only: <?php echo $var1_fullname_string; ?></td>
          <td width="24%" align="right"><span class="pheading"><strong class="stitle1">SPENDING</strong></span><strong class="stitle1"><br>
            </strong> <a class="btn btn-primary btn-sm" onClick="DETAILsubmit_4(<?php echo $report_uid * 3571 ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
              &nbsp;<strong>View Details</strong>&nbsp;</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="2" align="center"><span class="psub1">Total dollar spent per household is $<?php echo number_format($hhb_consume); ?>; <br>
        $<?php echo number_format(abs($hhdiff_consume)); if ($hhdiff_consume > 0) echo " higher"; else echo " lower"; ?> than the market area average of $<?php echo number_format($hha_consume); ?></span></td>
    </tr>
    <tr>
        ...
        <tr>
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
            <tr>
              <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                ...
                <tr>
                  <td height ='55' ><strong class="pbodyemp">&nbsp;&nbsp;&nbsp;$<?php echo number_format($hhbcommit); ?> target audience<br>
                   &nbsp;&nbsp;&nbsp; $<?php echo number_format($hhaD2000_2070c); ?> market area<br>
                   &nbsp;&nbsp;&nbsp; $<?php echo number_format($hhbD2000_2070c-$hhaD2000_2070c); ?> difference</strong></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  <tr>
                    <td height="40" align='center' class="sblue"><strong class="psub2">Controllable Spending</strong></td>
                    </tr>
                  <tr>
                  ...
                  <tr>
                    <td height ='55' ><strong class="pbodyemp">&nbsp;&nbsp;&nbsp;$<?php echo number_format($hhb_purchases); ?> target audience<br>
...
&nbsp;&nbsp;&nbsp;$<?php echo number_format($hhdiff_purchases); ?> difference</strong></td>
          ...
          <td width="220" align="center" valign="top"><table width='95%' class='Example_E1'>
              <tr>
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  <tr>
                    <td height="40" align='center' class="sblue"><strong class="psub2">Discretionary Spending</strong></td>
                    </tr>
                  <tr>
                  ...
                  <tr>
                    <td height ='55' ><strong class="pbodyemp">&nbsp;&nbsp;&nbsp;$<?php echo number_format($hhb_discretionary); ?> target audience<br>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="60%" align="left" valign="top" class="black12"><strong class="psub2">Store  # <?php echo $store_number; ?></strong><br>
            <span class="pbody">Target Audience only: <?php echo $var1_fullname_string; ?></span></td>
          <td width="25%" align="right"><span class="pheading"><strong class="stitle1">MEDIA</strong></span><strong class="stitle1"><br>
            </strong> <a class="btn btn-primary btn-sm" onClick="DETAILsubmit_5(<?php echo $report_uid * 3571 ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
              &nbsp;<strong>View Details</strong>&nbsp;</a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td><p>&nbsp;</p>
        <table width="100%" border="0" cellspacing="5" cellpadding="0">
          <tr>
            <td width="25%" align="center" valign="top"><table width="98%" height = "420" class="Example_E1" border="0" cellspacing="0" cellpadding="3">
              <tr class="sblue">
                <td align="center" height = "35" valign="top"><strong class="psub1">Online</strong></td>
              </tr>
              <tr>
...
<img src="green0.png" width="25" height="15" alt="green"><?php if ($binternetindex > 85) echo "<img src='green1.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 95) echo "<img src='green2.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 105) echo "<img src='green3.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 115) echo "<img src='green4.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?>
              ...
              <tr>
                <td valign="top"><span class="psub2"><strong>Target audience: <?php echo number_format($binternet_high ); ?>%<br>
                  Benchmark: 33.6% <br>
                  Index: <?php echo number_format($binternetindex ); ?></strong></span><strong><span class="sgrey14"><br>
                    </span></strong><span class="pbody"><br>
                    Heavy  users (15+ hours / week)</span></td>
              </tr>

            </table></td>
            <td width="25%" align="center" valign="top"><table width="98%" height = "420" class="Example_E1" border="0" cellspacing="0" cellpadding="3">
              <tr class="sblue">
                <td align="center" height = "35"valign="top"><strong class="psub1">Newspaper</strong></td>
              </tr>
              <tr>
...
<img src="green0.png" width="25" height="15" alt="green"><?php if ($bnpindex > 85) echo "<img src='green1.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 95) echo "<img src='green2.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 105) echo "<img src='green3.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 115) echo "<img src='green4.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?>
              ...
              <tr>
                <td valign="top"><span class="psub2"><strong>Target audience:<?php echo number_format($bnp_high ); ?>%<br>
                  Benchmark: 12.4% <br>
                  Index: <?php echo number_format($bnpindex ); ?></strong></span><br>
                    <span class="pbody"><br>
                    Heavy  readers (4+ hours / week)</span></td>
              </tr>
            ...
            <td width="25%" align="center" valign="top">
              ...
              <tr class="sblue">
                <td align="center" height = "35" valign="top"><strong class="psub1">Radio</strong></td>
              </tr>
              <tr>
...
<?php if ($bradioindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?></td>
              ...
              <tr>
                <td valign="top"><span class="psub2"><strong>Target audience:<?php echo number_format($bradio_high ); ?>%<br>
                  Benchmark: 18.7% <br>
                  Index: <?php echo number_format($bradioindex ); ?></strong></span><br>
                    <span class="pbody"><br>
                    Heavy  listeners (35+ hours/week)</span></td>
              </tr>
            </table></td>
            <td width="25%" align="center" valign="top"><table width="98%" height = "420" class="Example_E1" border="0" cellspacing="0" cellpadding="3">
              <tr class="sblue">
                <td align="center" height = "35" valign="top"><strong class="psub1">TV</strong></td>
              </tr>
              <tr>
...
<?php if ($btvindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?></td>
              ...
              <tr>
                <td valign="top"><span class="psub2"><strong>Target audience: <?php echo number_format($btv_high ); ?>%<br>
Benchmark: 18.6%% <br>
Index: <?php echo number_format($btvindex ); ?></strong></span><br>
<br>
<span class="pbody">Heavy  viewers (35+ hours/week)</span></td>
              </tr>
            </table></td>
          </tr>
        </table>
  ...
  <table width="100%" height="610" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="61"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" align="left" valign="top"><img src="KQUEST.png" width="113" height="50" alt="KQUEST"></td>
          <td width="60%" align="left" valign="top" class="black12"><strong class="black18">Store  # <?php echo $store_number; ?></strong><br>
            <span class="pbody">Target Audience only: <?php echo $var1_fullname_string; ?></span></td>
          <td width="25%" align="right"><span class="pheading"><strong class="stitle1">LIFESTYLE</strong></span><strong class="stitle1"><br>
            </strong> <a class="btn btn-primary btn-sm" onClick="DETAILsubmit_6(<?php echo $report_uid * 3571 ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
              &nbsp;<strong>View Details</strong>&nbsp;</a></td>
        </tr>
      </table></td>
    </tr>
