...
$start_zoom = 12;
// post fields
if (isset($_POST["store_selected"])) {	$store_uid = addslashes($_POST["store_selected"]);} else $store_uid = 0;
...
if($pc_name[$ele_count] == ",") { unset($pc_name[$ele_count]); $ele_count = $ele_count - 1; }

if($pc_name[0] == $pc_name[$ele_count])  unset($pc_name[$ele_count]);
$poly_list = implode("|", $pc_name);
    ...
    <td width="50%" align="center" valign="top" bgcolor="#FFFFFF"><table width="95%"  height="299" border="0" cellpadding="3" cellspacing="0" class="Example_E1">
      <tr>
        <td height="297"  align='left' valign="top" bgcolor="#FFFFFF"><table width="100%" height="100" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td  align='left' width="68%"><span class="sblue">Add a polygon is complete <span class="pbody14">
              <input name="store_selected" type="hidden" id="store_selected" value="<?php echo $store_uid;?>" />
              </span><br />
              <span class="pbody14">Store Number: <?php echo $store_number; ?><br />
Store Name: <?php echo $store_name; ?></span></span></td>
          </tr>
