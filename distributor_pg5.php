	...
	$.post("http://marketfocusdirect.ca/kquestsolutions/sp2_v1.php",<?php echo $json_post_encode; ?> , function (data,status) {
			...
			if(status == 'success') {
				...
				var route_table = "<table  id='example' width='100%' class='stripe display nowrap'>";
					route_table += "<thead><tr style='background-color:#900C3F;color: white;'><th>LINE</th>";
					route_table += "<th>MFDCODE</th>";
					route_table += "<th>DISTRIBUTOR</th>";
					route_table += "<th>ROUTE</th>";
					route_table += "<th>PRIMEFSA</th>";
					route_table += "<th>MARKET</th>";
					route_table += "<th>HOMES</th>";
					route_table += "<th>APTS</th>";
					route_table += "<th>AVG_SCORE</th>";
					route_table += "<th>QTY</th>";
					route_table += "<th>ACCUM_QTY</th>";
					route_table += "<th>SELECTED</th></tr></thead><tbody>";
...
buttons: [
			...
			extend: 'excelHtml5',
			text : 'EXCEL',
			title:'Distributors Found' ,
			filename: function(){
                var d = new Date();
                return 'Distributors Found - ' + d;
			}
			},
			{
				extend: 'pdfHtml5',
