...
<tr>
<td width="900" colspan="2" align="center" valign="middle" class="blue22"><p ><strong class="stitle">
  <!--to put message here  -->
  <?php 
  ...
  <td><table width="900" height="214" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
      ...
      <td width="450" valign="top" height="400"><table width="100%" height="400"  border="1" align="center" cellpadding="1" cellspacing="0" class="style4">
        <tr>
          <td width="225" style="padding-left:14px"><strong>Restaurant Annual Visits</strong></td>
        ...
        <tr>
          <td style="padding-left:14px">Boston Pizza</td>
        ...
        <tr>
          <td style="padding-left:14px">Earls</td>
        ...
        <tr>
          <td style="padding-left:14px">East Side Marios</td>
        ...
        <tr>
          <td style="padding-left:14px">Jack Astor's</td>
        ...
        <tr>
          <td style="padding-left:14px">The Keg</td>
        ...
        <tr>
          <td style="padding-left:14px">Kelsey's</td>
        ...
        <tr>
          <td style="padding-left:14px">Milestones</td>
        ...
        <tr>
          <td style="padding-left:14px">Montana's</td>
        ...
        <tr>
          <td style="padding-left:14px">Original Joe's</td>
        ...
        <tr>
          <td style="padding-left:14px">Pizza Hut</td>
        ...
        <tr>
          <td style="padding-left:14px">St. Hubert</td>
        ...
        <tr>
          <td style="padding-left:14px">Swiss Chalet</td>
  ...
  <td><table width="900" height="214" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
      <td width="50%" height="107"><table width="100%" height="400" border="1" align="center" cellpadding="1" cellspacing="0" class="style4">
        <tr>
            <td width="300" class="style4" style="padding-left:14px"><strong>Restaurant Annual Visits</strong></td>
            <td width="75"><div align="center"><strong>Market</strong></div></td>
            <td width="75"><div align="center"><strong>Benchmark</strong></div></td>
            <td width="75"><div align="center"><strong>Index</strong></div></td>
            </tr>
          <tr>
            <td style="padding-left:14px">A&amp;W</td>
          ...
          <tr>
            <td style="padding-left:14px">Arby's</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][13],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Burger King</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][14],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Dairy Queen</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][15],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Dominos</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][16],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Harvey's</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][17],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">KFC</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][18],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">McDonald's</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][19],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Mr. Sub</td>
            ...
            <td><div align="center"><?php echo number_format($rest_vals['index'][20],0); ?></div></td>
             ...
             <tr>
            <td style="padding-left:14px">Pizza Pizza</td>
            ...
            <tr>
            <td style="padding-left:14px">Quizno's</td>
            ...
            <tr>
            <td style="padding-left:14px">Subway</td>
            ...
            <tr>
            <td style="padding-left:14px">Taco Bell</td>
            ...
            <tr>
            <td style="padding-left:14px">Taco Time</td>
            ...
            <tr>
            <td style="padding-left:14px">Valentine</td>
            ...
            <tr>
            <td style="padding-left:14px">Wendy's</td>
  ...
  <td><table width="900" height="214" border="0" cellspacing="0" cellpadding="6">
    ...
    <tr>
      ...
      <td width="450" valign="top" padding-right:="padding-right:"""><table width="100%" height="390"  border="1" align="center" cellpadding="1" cellspacing="0" class="style4">
        <tr>
          <td width="300" style="padding-left:14px"><strong>Restaurant Annual Visits</strong></td>
          <td width="75"><div align="center"><strong>Market</strong></div></td>
          <td width="75"><div align="center"><strong>Benchmark</strong></div></td>
          <td width="75"><div align="center"><strong>Index</strong></div></td>
        </tr>
        <tr>
          <td style="padding-left:14px">Coffee Time</td>
        ...
        <tr>
          <td style="padding-left:14px">Country Style</td>
        ...
        <tr>
          <td style="padding-left:14px">David's Tea</td>
        ...
        <tr>
          <td style="padding-left:14px">Dunkin' Donuts</td>
        ...
        <tr>
          <td style="padding-left:14px">Great Canadian Bagel</td>
        ...
        <tr>
          <td style="padding-left:14px">Muffins</td>
        ...
        <tr>
          <td style="padding-left:14px">Second Cup</td>
        ...
        <tr>
          <td style="padding-left:14px">Starbucks</td>
        ...
        <tr>
          <td style="padding-left:14px">Tim Horton's</td>
        ...
        <tr>
          <td style="padding-left:14px">Timothy's</td>
...
<div class="noprint"> <br /></div>
<div class="pagebreak"></div>
<div class="print_pages rest" align="left">
  <td><table width="900" height="214" border="0" cellspacing="0" cellpadding="6">
    <tr>
      <td height="70" colspan="2" padding-right:="padding-right:"""><table width="890" height="62"border="0" cellspacing="" cellpadding="4">
        <tr>
    ...
    <tr>
      ...
      <td width="450" valign="top" padding-right:="padding-right:"""><table width="100%" height="510"  border="1" align="center" cellpadding="1" cellspacing="0" class="style4">
        ...
        <tr>
          <td style="padding-left:14px">Breakfast</td>
        ...
        <td style="padding-left:14px">Burger Restaurant</td>
        ...
        <td style="padding-left:14px">Family Dining</td>
        ...
        <td style="padding-left:14px">Chicken Restaurants</td>
        ...
        <td style="padding-left:14px">Coffee / Donut Shop</td>
        ...
        <td style="padding-left:14px">Food Court</td>
        ...
        <td style="padding-left:14px">Ice Cream Parlour</td>
        ...
        <td style="padding-left:14px">Oriental</td>
        ...
        <td style="padding-left:14px">Italian</td>
        ...
        <td style="padding-left:14px">Mexican</td>
        ...
        <td style="padding-left:14px">Other Ethnic Restaurants</td>
        ...
        <td style="padding-left:14px">Pizza Restaurants</td>
          <td><div align="center"><?php echo number_format($rest_vals['file'][50],1); ?>%</div></td>
          <td><div align="center"><?php echo number_format($rest_vals['bench'][50],1); ?>%</div></td>
          <td><div align="center"><?php echo number_format($rest_vals['index'][50],0); ?></div></td>
        </tr>
        <td style="padding-left:14px">Pubs</td>
        ...
        <td style="padding-left:14px">Seafood</td>
        ...
        <td style="padding-left:14px">Steakhouse</td>
        ...
        <td style="padding-left:14px">Sub Sandwiches</td>
        ...
        <td style="padding-left:14px">Formal Dining</td>
        ...
        <tr>
           <td style="padding-left:14px">Take Out</td>
        ...
        <tr>
           <td style="padding-left:14px">Home Delivery</td>
        ...
        <tr>
           <td style="padding-left:14px">Dine In</td>
        ...
        <tr>
           <td style="padding-left:14px">Drive Through</td>
        ...
        <tr>
           <td style="padding-left:14px">Online Order</td>
