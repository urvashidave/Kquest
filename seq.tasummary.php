...
<tr>
<td width="900" colspan="2" align="center" valign="middle"><span class="blue22"><strong><?php echo strtoupper($report_label_type);?></strong></span><br>
<span class="black18"><br></span>
<span class="black22"><?php echo $change_header; ?> </span>
<span class="black18"><br><?php echo $change_title; ?><br />
...
<tr>
<td colspan="2" align="center" valign="bottom" class="sorange16"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<td width="192" height="62" align="left" valign="middle"><strong class="stitle">LOCATION</strong><br /><?php if($detail_show == 0) echo "<button class='form-button-blue bg_color1' onclick='change_report2()'>Show Retailer Map</button>"; ?>
</td>
</tr>
...
<?php 
$show_charts = strlen($seq_deciles);

if($show_charts > 1) {echo "<div class='no-print no_print'><br /></div>";  include "seq_charts.php"; echo "<div class='no-print no_print'><br /></div>"; } ?>

<?php if ($detail_show == 10 ) include "ui_retailermap.php"; ?>
<div class="print_pages" align="left" style="height:625px">
<table width="911" height="600" border="0" cellspacing="" cellpadding="4" >
<tr>
<td width="900" height="107" colspan="2" padding-right:""> <table width="99%" border="0" cellspacing="2" cellpadding="2">
<tr>
<td width="125" height="48"  padding-right:"5" align="left" valign="top"><img src="image3/KQUEST.png" alt="KQUEST" width="113" height="50" align="top"></td>
...
<div id="piechart_3d" style="width: 440px; height: 300px;"></div></td>
<td align="center"><span class="style2" style="font-size: 17px">Ethnic Diversity</span>
<div id="piechart_3d2aa" style="width: 440px; height: 300px;"></div></td>
</tr>
</table>
</div>

<div class="no-print no_print"><br /></div>
...
<tr>
<td height="74" align="center" valign="top" class="black18"><p style="margin: 0; padding: 0;"><strong>
<?php 
...
?> Vital segments were identified <br>
These vital segments represent <?php echo number_format($vitalsegment_p); ?>% of households analyzed
<br> 
</strong >and <?php echo number_format($vitalsegment_c); ?>% of benchmark households (index <?php echo number_format($vitalsegment_p / $vitalsegment_c *100); ?>) </p></td>
</tr>
<tr>
...
<tr>
<td colspan="2" align="center" class="black18" ><p><strong>$<?php echo number_format($hhb_consume); ?> Total dollar spend per households (all analyzed households)</strong><br>
...
<tr>
<td height="30" align="center" class="black18" ><strong>Media Usage (all households analyzed)</strong ></td>
</tr>
</tr>
<tr>
<td>
...
<div class="print_pages_last last_page" align="left" style="height:625px;">
