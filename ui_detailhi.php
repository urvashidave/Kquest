 ...
 <img src="red.png" alt="benchmark" width="100%" height="<?php echo round($crenospend_0_chart);?>" /></td>
 ...
 <td width="50" align="center" valign="bottom"><?php echo number_format($crenospend_low); ?>%<br />         <img src="red.png" alt="benchmark" width="100%" height="<?php echo round($crenospend_low_chart);?>" /></td>
 <td width="15" align="center" valign="bottom">&nbsp;</td>
 ...
 <img src="red.png" alt="benchmark" width="100%" height="<?php echo round($crenospend_mid_chart);?>" /></td>
 <td width="15" align="center" valign="bottom">&nbsp;</td>
 ...
 <img src="red.png" alt="benchmark" width="100%" height="<?php echo round($crenospend_high_chart); ?>" /></td>
 ...
 Top renovations in the past 2 years ranked by percent of households</td>
 </tr>
 </table>
 </div>
...
<div class="pagebreak"><br /> </div>
 ...
 <td align="center"><?php echo number_format($cDW_ARMSPDW,1);?></td>
 <td align="center"><?php echo number_format($iDW_ARMSPDW);?></td>
 </tr>
 <tr class="style12">
 <td>Average Dwelling Value</td>
 <td align="center">$<?php echo number_format($pDW_AVALUE);?></td>
 <td align="center">$<?php echo number_format($cDW_AVALUE);?></td>
 <td align="center"><?php echo number_format($iDW_AVALUE);?></td>
 </tr>
 <tr class="style12">
 <td>&nbsp;</td>
 <td align="center">&nbsp;</td>
 ...
 <tr >
 <th align="left"><strong><span class="pbodyemp">Period of Construction </span></strong></th>
 ...
 <tr class="style12"><td>1960 or before</td><td align="center"><?php echo number_format($pDW_CON_60,1);?>%</td><td align="center"><?php echo number_format($cDW_CON_60,1);?>%</td><td align="center"><?php echo number_format($iDW_CON_60);?></td></tr>
 <tr class="style12"><td>1961 to 1980</td><td align="center"><?php echo number_format($pDW_CON6180,1);?>%</td><td align="center"><?php echo number_format($cDW_CON6180,1);?>%</td><td align="center"><?php echo number_format($iDW_CON6180);?></td></tr>
 <tr class="style12"><td>1981 to 1990</td><td align="center"><?php echo number_format($pDW_CON8190,1);?>%</td><td align="center"><?php echo number_format($cDW_CON8190,1);?>%</td><td align="center"><?php echo number_format($iDW_CON8190);?></td></tr>
 <tr class="style12"><td>1991 to 2000</td><td align="center"><?php echo number_format($pDW_CON9100,1);?>%</td><td align="center"><?php echo number_format($cDW_CON9100,1);?>%</td><td align="center"><?php echo number_format($iDW_CON9100);?></td></tr>
 <tr class="style12"><td>2001 to 2005</td><td align="center"><?php echo number_format($pDW_CON0105,1);?>%</td><td align="center"><?php echo number_format($cDW_CON0105,1);?>%</td><td align="center"><?php echo number_format($iDW_CON0105);?></td></tr>
 <tr class="style12">
 <td>2006 to 2011</td>
 <td align="center"><?php echo number_format($pDW_CON0611,1);?>%</td><td align="center"><?php echo number_format($cDW_CON0611,1);?>%</td><td align="center"><?php echo number_format($iDW_CON0611);?></td></tr>
 <tr class="style12">
...
<div class="pagebreak"><br /> </div>
 ...
 <td width="38%" align="center"  valign="top" ><div align="centre"><img src="pics560/home_improve.jpg" alt="retailers" width="311" height="170" align="center" /></div></td>
 </tr>
 </table>
 </div>
<div class="pagebreak"><br /> </div>
