...
, SUM(wei.HC_WCPIL*PP15_) as HC_WCPIL

, SUM(wei.HC_WCDR*PP15_) as HC_WCDR

, SUM(wei.HC_WCMR*PP15_) as HC_WCMR

, SUM(wei.HC_WCEX*PP15_) as HC_WCEX

, SUM(wei.HC_WCMO*PP15_) as HC_WCMO

, SUM(wei.HC_WCNU*PP15_) as HC_WCNU

, SUM(wei.HC_WCJE*PP15_) as HC_WCJE

, SUM(wei.HC_WCWW*PP15_) as HC_WCWW

, SUM(wei.HC_WCOTC*PP15_) as HC_WCOTC

, SUM(wei.HC_WCOT*PP15_) as HC_WCOT



 FROM a12_mfd_demo demo, a12_demo_mn mn, a12_mfd_bbm bbm, a12_mfd_sp sp, a12_mfd_sp3 sp3, a12_sp1_a asp1, a12_sp2_a asp2, a12_sp3_a asp3, amfd_pclist pclist, a_tempweight wei WHERE pclist.store_uid = $store_uid and pclist.PostCode = demo.PostCode and pclist.PostCode = mn.PostCode and pclist.PostCode = bbm.PostCode and pclist.PostCode = sp.POSTCODE and pclist.PostCode = sp3.POSTCODE and pclist.PostCode = asp1.PostCode and pclist.PostCode = asp2.PostCode and pclist.PostCode = asp3.PostCode and pclist.PostCode = wei.PostCode";
...
,SUM(fly.FLY_DPN * a_weight.pp15_) as FLY_DPN
...
, SUM(fly.FLY_CNPF * a_weight.pp15_) as FLY_CNPF
 ...
 FROM a16_fly fly, a16_weight a_weight, amfd_pclist pclist WHERE pclist.store_uid = $store_uid and pclist.PostCode = fly.POSTCODE  and pclist.PostCode = a_weight.postcode ";
...
$pb_flyer_heavy = $pbFLY_CNPF;
$canp_flyer_heavy = $canp_FLY_CNPF;
...
<div class="container row col-md-12 no-print align="center"">  
    ...
    <td width="80%"><input name="change_header" type="text" class="black14" id="change_header" value="<?php echo $change_header; ?>" size="50" maxlength="150">
    ...
    <td width="20%"><a class="btn btn-success" onClick="TITLEsubmit2(<?php echo $store_uid ; ?>);">

	<i class="fa fa-bullseye fa-lg"></i>Change Title</a></td>
  ...
  <tr>
    ...
    <td width="880" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="50%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br>

          <?php echo $change_title2; ?></span></td>

        <td width="35%" align="right"><strong class="stitle">LOCATION</strong></td>
  ...
  <table width="900px" height="610" border="0" cellspacing="0" cellpadding="0">
      ...
      <td colspan="2" class="sorange20"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
         ...
         <td width="50%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br>
          ...
          <td width="35%" align="right"><strong class="stitle">DEMOGRAPHICS<br>
    ...
    <tr>
      ...
      <td align="center"><span class="black16">Household Income</span>
        ...
        <div id="piechart_3d" style="width: 400px; height: 240px;"></div></td>

      <td align="center"><span class="black16">Ethnic Diversity</span>

        <div id="piechart_3d2" style="width: 400px; height: 240px;"></div></td>
...
<div class="container row col-md-12 print_pages align="left""> 
  ...
  <table width="905" height="600" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="905" height="585" colspan="2"><table width="100%" height="600" border="0" cellspacing="0" cellpadding="5">
          ...
          <?php echo $change_title2; ?></span></td>
                        ...
                        <td width="35%" align="right" valign="top"><strong class="stitle">SEGMENTATION<span class="sgrey14"><br><a class="btn btn-primary btn-sm" onClick="view_description();"><i class="fa fa-file-text fa-lg"></i>&nbsp; &nbsp; View Descriptions</a>
    ...
    <tr>
      ...
      <td width="500" colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="40%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br>

          <?php echo $change_title2; ?></span></td>

          <td width="45%" align="right" valign="top"><strong class="pheading">HOUSEHOLD SPEND</strong><br>
            ...
            <tr>
              ...
              <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                ...
                <tr>
                  ...
                  <td height="35" align='center' class="psub2"><strong>Essential Spending</strong></td>
              ...
              <tr>
                ...
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                  ...
                  <tr>
                    ...
                    <td height="35" align='center' class="psub2"><strong>Controllable Spending</strong></td>
              ...
              <tr>
                ...
                <td><table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor="#FFFFFF">
                  ...
                  <tr>
                    ...
                    <td height="35" align='center' class="psub2"><strong>Discretionary Spending</strong></td>
                  ...
                  <tr>
                    ...
                    <td height ='65' ><strong class="pbodyemp">&nbsp;&nbsp;&nbsp;&nbsp;$<?php echo number_format($hhb_discretionary); ?> market area<br>
...
<span class="black8">* Trade area compared to the National average </span></div>
...
<div class="container row col-md-12 print_pages align="left"">
  <?php if ($binternetindex > 85) echo "<img src='green1.png' width='25' height='15' alt='green'>";?>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
         ...
         <td width="50%" align="left"><span class="psub2"><?php echo $change_header; ?></span><span class="black16"><br>
          ...
          <td width="35%" align="right"><strong class="stitle">MEDIA</strong><br>
      ...
      <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
          ...
          <tr>
            <td width="25%" align="center" valign="top"><table width="95%" height = "415" class="Example_E1" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td valign="top"><span class="sgrey14"><strong>Market Area: <?php echo number_format($pb_flyer_heavy); ?>%<br>
                  National Average: <?php echo number_format($canp_flyer_heavy); ?>% <br>
                  Index: <?php echo number_format($index_flyer_heavy); ?></strong></span><strong><span class="sgrey14"><br>
                    </span></strong><br>
                  <span class="sgrey12">Heavy  users (freq. read weekly)</span></td>
              </tr>
            </table></td>
...
<img src="green0.png" width="25" height="15" alt="green"><?php if ($binternetindex > 85) echo "<img src='green1.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 95) echo "<img src='green2.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 105) echo "<img src='green3.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 115) echo "<img src='green4.png' width='25' height='15' alt='green'>";?><?php if ($binternetindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?>
            ...
            <td width="25%" align="center" valign="top"><table width="95%" height = "415" class="Example_E1" border="0" cellspacing="0" cellpadding="3">
...
<img src="green0.png" width="25" height="15" alt="green"><?php if ($bnpindex > 85) echo "<img src='green1.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 95) echo "<img src='green2.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 105) echo "<img src='green3.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 115) echo "<img src='green4.png' width='25' height='15' alt='green'>";?><?php if ($bnpindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?>
            ...
            <td width="25%" align="center" valign="top">
              ...
              <table width="95%" height = "415" class="Example_E1" border="0" cellspacing="0" cellpadding="3">
...
<?php if ($bradioindex > 125) echo "<img src='green5.png' width='25' height='15' alt='green'>";?></td>
        ...
        </table><span class="black8">*Trade area compared to National average </span>
    ...
    <tr>
      ...
      <td height="61"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="35%" align="right" valign="top"><strong class="stitle">LIFESTYLE</strong><br>
...
<a class="btn btn-primary btn-sm" onClick="detail_show6(<?php echo $store_uid ; ?>);"><i class="fa fa-file-text fa-lg"></i>&nbsp;
    ...
    <tr>
      ...
      <td height="30" align="center" class="black18"><strong>Top 8 Lifestyle Activities (out of 43)</strong></td>
