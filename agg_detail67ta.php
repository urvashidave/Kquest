...
, SUM(leis.LS_MUSM*media.pp15_) as LS_MUSM
, SUM(leis.LS_EXHBT*media.pp15_) as LS_EXHBT
, SUM(leis.LS_HIST*media.pp15_) as LS_HIST
, SUM(leis.LS_CTPRK*media.pp15_) as LS_CTPRK
, SUM(leis.LS_MAXMV*media.pp15_) as LS_MAXMV
, SUM(leis.LS_SPEVN*media.pp15_) as LS_SPEVN
, SUM(leis.LS_AMUSE*media.pp15_) as LS_AMUSE
, SUM(leis.LS_THMPK*media.pp15_) as LS_THMPK
, SUM(leis.LS_ZOO*media.pp15_) as LS_ZOO
, SUM(leis.LS_OTHAT*media.pp15_) as LS_OTHAT
, SUM(leis.LS_STDM*media.pp15_) as LS_STDM
, SUM(leis.LS_CS*media.pp15_) as LS_CS
, SUM(leis.LS_NTCLB*media.pp15_) as LS_NTCLB
, SUM(leis.LS_ODSTG*media.pp15_) as LS_ODSTG
, SUM(leis.LS_THTR*media.pp15_) as LS_THTR

, SUM(leis.LS_MJTHT*media.pp15_) as LS_MJTHT
, SUM(leis.LS_CMTHT*media.pp15_) as LS_CMTHT
, SUM(leis.LS_FSTVL*media.pp15_) as LS_FSTVL
, SUM(leis.LS_OTTHT*media.pp15_) as LS_OTTHT
, SUM(leis.LS_CLSCC*media.pp15_) as LS_CLSCC
, SUM(leis.LS_BAR*media.pp15_) as LS_BAR
, SUM(leis.LS_CMCLB*media.pp15_) as LS_CMCLB
, SUM(leis.LS_DNCLB*media.pp15_) as LS_DNCLB
, SUM(leis.LS_DITHT*media.pp15_) as LS_DITHT
, SUM(leis.LS_FMFST*media.pp15_) as LS_FMFST
, SUM(leis.LS_MSFST*media.pp15_) as LS_MSFST
, SUM(leis.LS_MVTHT*media.pp15_) as LS_MVTHT
, SUM(leis.LS_NPPK*media.pp15_) as LS_NPPK
, SUM(leis.LS_POPCC*media.pp15_) as LS_POPCC

, SUM(leis.LS_LATRC*media.pp15_) as LS_LATRC
, SUM(leis.LS_LBSBL*media.pp15_) as LS_LBSBL
, SUM(leis.LS_LBSKB*media.pp15_) as LS_LBSKB
, SUM(leis.LS_LFSKT*media.pp15_) as LS_LFSKT
, SUM(leis.LS_LFTBL*media.pp15_) as LS_LFTBL
, SUM(leis.LS_LGLF*media.pp15_) as LS_LGLF
, SUM(leis.LS_LHCKY*media.pp15_) as LS_LHCKY
, SUM(leis.LS_LHSRC*media.pp15_) as LS_LHSRC
, SUM(leis.LS_LLCRS*media.pp15_) as LS_LLCRS
, SUM(leis.LS_LSCC*media.pp15_) as LS_LSCC
, SUM(leis.LS_LTNS*media.pp15_) as LS_LTNS
, SUM(leis.LS_FITCLB*media.pp15_) as LS_FITCLB
, SUM(leis.LS_GLFCLB*media.pp15_) as LS_GLFCLB
...
FROM a16_fly fly, a16_weight a_weight, a12_bbm_it inter, amfd_pclist pclist WHERE pclist.PostCode = inter.POSTCODE and pclist.store_uid = $store_uid and pclist.PostCode = fly.POSTCODE  and pclist.PostCode = a_weight.postcode";
